...
caused_by:
  code: '3381'
  title: '"Қазақстан Республикасындағы сайлау туралы" Қазақстан Республикасының Конституциялық заңына өзгерістер енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/3381/kaz
