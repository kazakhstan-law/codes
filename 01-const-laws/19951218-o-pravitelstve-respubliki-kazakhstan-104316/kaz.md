...
caused_by:
  code: '2840'
  title: Қазақстан Республикасы Президентінің "Қазақстан Республикасының Үкіметі туралы" конституциялық заң күші бар Жарлығына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/2840/kaz
source: https://zan.gov.kz/client/#!/doc/104316/kaz/05.05.1999
---
...
6) қолданылып жүрген заңдарда белгiленген өзге де функцияларды атқарады.
...
4) қолданылып жүрген заңдарда белгiленген өзге де функцияларды атқарады.
