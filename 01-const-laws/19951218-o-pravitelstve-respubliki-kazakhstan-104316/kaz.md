...
caused_by:
  code: '33755'
  title: '"Қазақстан Республикасының Үкіметі туралы" Қазақстан Республикасының Конституциялық заңына өзгерістер мен толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/33755/kaz
source: https://zan.gov.kz/client/#!/doc/104316/kaz/19.06.2007
---
