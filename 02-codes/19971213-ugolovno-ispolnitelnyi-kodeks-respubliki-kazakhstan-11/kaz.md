...
requisite: Қазақстан Республикасының 1997 жылғы 13 желтоқсандағы № 208 Кодексі. Күші жойылды - Қазақстан Республикасының 2014 жылғы 5 шілдедегі № 234-V (2018 жылғы 1 қаңтардан бастап күшін жоятын 58-бапты және Қылмыстық-атқару кодексіне Қосымшаның 1-тармағын қоспағанда, 2015 жылғы 1 қаңтардан бастап қолданысқа енгізіледі) Қылмыстық-атқару кодексімен
form: КОД
type_codes:
- КОД
approved_by:
...
caused_by:
  code: '9779'
  title: Қазақстан Республикасының кейбір заң актілеріне қылмыстық-атқару жүйесін реформалау және осы жүйе қызметкерлерінің мәртебесі мәселелері бойынша өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/9779/kaz
