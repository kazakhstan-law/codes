...
caused_by:
  code: '66224'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам противодействия легализации (отмыванию) доходов, полученных незаконным путем, и финансированию терроризма и обналичивания денег
  link: https://zan.gov.kz/client/#!/doc/66224/rus
source: https://zan.gov.kz/client/#!/doc/9/rus/21.06.2012
---
