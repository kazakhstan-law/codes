...
caused_by:
  code: '53459'
  title: Қазақстан Республикасының кейбiр заңнамалық актiлерiне кедендік реттеу және салық салу мәселелері бойынша өзгерiстер мен толықтырулар енгiзу туралы
  link: https://zan.gov.kz/client/#!/doc/53459/kaz
