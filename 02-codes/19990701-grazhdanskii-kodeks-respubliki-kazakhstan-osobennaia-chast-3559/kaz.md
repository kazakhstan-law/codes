...
caused_by:
  code: '31400'
  title: Қазақстан Республикасының Азаматтық кодексiне (Жалпы және Ерекше бөлiмдер) өзгерiстер мен толықтырулар енгiзу туралы
  link: https://zan.gov.kz/client/#!/doc/31400/kaz
source: https://zan.gov.kz/client/#!/doc/3559/kaz/12.01.2007
---
...
2. Мүлiктi сенiмгерлiкпен басқару:
   ...
   3) әкімшілік акт (кәмелетке толмаған, қайтыс болған адамның мүлкiне қорғаншылық белгiлеген; кәсiпкер мемлекеттiк қызметке кiрген кезде және заң актiлерiнде көзделген басқа жағдайларда) негiзiнде пайда болады (белгiленедi).
      ...
      > *Ескерту. 883-бапқа өзгерту енгізілді - Қазақстан Республикасының 2007.01.12. N 225 Заңымен.*
