...
source: https://zan.gov.kz/client/#!/doc/3583/rus/25.03.2011
---
...
1. Уплаченная государственная пошлина подлежит возврату плательщику частично или полностью в случаях:
   ...
   2) возвращения апелляционной, кассационной жалобы по основаниям, предусмотренным статьей 337 настоящего Кодекса.
      ...
      Часть первую предусмотрено дополнить подпунктом 3) в соответствии с Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
1. Судья отказывает в принятии искового заявления, если:
   ...
   1) заявление не подлежит рассмотрению и разрешению в порядке гражданского судопроизводства;
      ...
      В подпункт 2) предусмотрено изменение Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
3) разрешает вопрос о вступлении в дело соистцов, соответчиков и третьих лиц без самостоятельных требований, а также решает вопрос о замене ненадлежащего ответчика;
   ...
   В подпункт 4) предусмотрено изменение Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
2. Основания для отводов, порядок разрешения заявленного отвода и последствия удовлетворения таких заявлений определяются статьями 40-43 настоящего Кодекса.
   ...
   В статью 185 предусмотрено изменение Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
В статью 192 предусмотрено изменение Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
В статью 193 предусмотрены изменения Законом РК от 28.01.2011 № 402 (вводятся в действие по истечении шести месяцев после его первого официального опубликования).
...
5. Если после вступления в законную силу решения, которым с ответчика взыскиваются периодические платежи, изменяются обстоятельства, влияющие на определение размера платежей или на их продолжительность, каждая сторона вправе путем предъявления нового иска требовать изменения размера и сроков платежей.
   ...
   > *Сноска. Статья 235 с изменениями, внесенными законами РК от 11.07.2001 N 238; от 11.07.2009 N 185-IV (вводится в действие с 30.08.2009); от 10.12.2009 № 227-IV (вводится в действие с 01.01.2010); от 01.03.2011 № 414-IV (вводится в действие с 01.01.2010).*
...
3. На определение суда по вопросу об отсрочке или рассрочке исполнения, а также об изменении способа и порядка его исполнения может быть подана частная жалоба или принесен протест.
   ...
   В пункт 4 предусмотрено изменение Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
4. По правилам настоящей статьи могут производиться отсрочка, рассрочка или изменение способа мирового соглашения сторон, утвержденного судом.
   ...
   > *Сноска. Статья 240 с изменениями, внесенными Законом РК от 02.04.2010 № 262-IV (вводится в действие с 21.10.2010).*
...
6) обращения с поручением суду иностранного государства об оказании правовой помощи.
   ...
   Статью 242 предусмотрено дополнить подпунктом 7) в соответствии с Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
5) в случаях, предусмотренных подпунктом 6) статьи 242, подпунктом 6) статьи 243 настоящего Кодекса, - до выполнения судом поручения об оказании правовой помощи.
   ...
   Статью 244 предусмотрено дополнить подпунктом 6) в соответствии с Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
4) стороны заключили мировое соглашение и оно утверждено судом;
   ...
   Статью 247 предусмотрено дополнить подпунктом 4-1) в соответствии с Законом РК от 28.01.2011 № 402 (вводится в действие по истечении шести месяцев после его первого официального опубликования).
...
2. В случае прекращения производства по делу вторичное обращение в суд по спору между теми же сторонами, о том же предмете и по тем же основаниям не допускается. .X0000000149
...
1. Копия заочного решения высылается ответчику не позднее трех дней со дня его вынесения с уведомлением о вручении. .X0000000283
...
2. О принятии отказа от жалобы и отзыва протеста суд выносит постановление, которым прекращает апелляционное производство, если решение не обжаловано другими лицами или не опротестовано вышестоящим прокурором.
   ...
   В статью 342 предусмотрены изменения Законом РК от 28.01.2011 № 402 (вводятся в действие по истечении шести месяцев после его первого официального опубликования).
...
3. О принятии отказа от жалобы и при отзыве протеста суд выносит определение, которым прекращает кассационное производство, если решение не обжаловано или не опротестовано другими лицами.
   ...
   В статью 383-11 предусмотрены изменения Законом РК от 28.01.2011 № 402 (вводятся в действие по истечении шести месяцев после его первого официального опубликования).
