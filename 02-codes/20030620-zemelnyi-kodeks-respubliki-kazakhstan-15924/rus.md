...
source: https://zan.gov.kz/client/#!/doc/15924/rus/29.09.2014
---
...
1. К землям для нужд автомобильного транспорта относятся земли, отведенные:
   ...
   Подпункт 1) предусмотрен в редакции Закона РК от 17.04.2014 № 195-V (вводится в действие по истечении шести месяцев после дня его первого официального опубликования).
