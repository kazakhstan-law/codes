...
caused_by:
  code: '144587'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам обеспечения  доступности Интернета в сельских населенных пунктах
  link: https://zan.gov.kz/client/#!/doc/144587/rus
