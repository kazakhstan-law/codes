...
source: https://zan.gov.kz/client/#!/doc/33263/rus/03.07.2014
---
...
5. Орган, возглавляющий забастовку, имеет право на обжалование решения суда в порядке, установленном законами Республики Казахстан.
   ...
   Статью 303 предусмотрено дополнить пунктом 6 в соответствии с Законом РК от 03.07.2014 № 227-V (вводится в действие с 01.01.2015).
