...
4. При безвозмездной передаче фиксированных активов стоимостный баланс подгруппы (группы) уменьшается на стоимость, определяемую по данным акта приема-передачи названных активов.
