...
2. Содержание иных терминов определяется отдельными статьями настоящего Кодекса.
   ...
   > *Сноска. Статья 1 с изменениями, внесенными Законом РК от 29.12.2010 № 372-IV (вводится в действие по истечении десяти календарных дней после его первого официального опубликования).*
