...
source: https://zan.gov.kz/client/#!/doc/53448/rus/24.12.2012
---
...
9. С целью учета декларанта или таможенного представителя в электронном (автоматизированном) виде в таможенный орган представляются следующие документы:
   ...
   2) для физических лиц:
      ...
      > *Сноска. Статья 281 с изменением, внесенным Законом РК от 24.12.2012 № 60-V (вводится в действие по истечении десяти календарных дней после его первого официального опубликования).*
