...
caused_by:
  code: '101452'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам защиты прав ребенка
  link: https://zan.gov.kz/client/#!/doc/101452/rus
source: https://zan.gov.kz/client/#!/doc/81238/rus/09.04.2016
---
...
2) тяжкие и особо тяжкие преступления или судимыми два и более раза к лишению свободы за умышленные преступления и имевшими на момент окончания срока наказания третью отрицательную степень поведения.
   ...
   > *Сноска. Статья 171 с изменением, внесенным Законом РК от 09.04.2016 № 501-V (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
