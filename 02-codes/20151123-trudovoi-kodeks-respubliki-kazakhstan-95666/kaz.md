...
caused_by:
  code: '156720'
  title: Қазақстан Республикасының Еңбек кодексіне қашықтан жұмыс істеудің құқықтық реттелуін жетілдіру мәселелері бойынша өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/156720/kaz
