...
caused_by:
  code: '219945'
  title: О внесении изменений и дополнений в Кодекс Республики Казахстан «О недрах и недропользовании» по вопросам совершенствования недропользования в сфере углеводородов и урана
  link: https://zan.gov.kz/client/#!/doc/219945/rus
source: https://zan.gov.kz/client/#!/doc/117131/rus/26.02.2026
---
...
Статья 68-1. Вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
...
2. Программа управления государственным фондом недр разрабатывается на основе анализа перспектив развития сферы недропользования и с учетом:
   ...
   11) возможностей существующей инфраструктуры.
       ...
       12) вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
...
3-1. Вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
...
2. Результаты аукциона подводятся автоматически на основании реестра итогов электронных аукционов на объекте информатизации оператора электронных аукционов на предоставление права недропользования по углеводородам в день его проведения.
   ...
   Результаты аукциона в течение одного рабочего дня со дня его проведения должны быть размещены на интернет-ресурсе компетентного органа на казахском и русском языках.
...
2. Объявление о признании аукциона несостоявшимся подлежит размещению на интернет-ресурсе компетентного органа на казахском и русском языках в течение одного рабочего дня со дня завершения аукциона.
...
5. Обязательства по консервации участка недр по углеводородам исполняются за счет средств недропользователя либо лица, право недропользования которого прекращено, а в случае, предусмотренном подпунктом 2) пункта 4 статьи 107 настоящего Кодекса, суммы обязательств после их исполнения компенсируются недропользователю за счет средств обеспечения.
   ...
   > *Сноска. Статья 127 с изменением, внесенным законом РК от 26.12.2025 № 243-VIII (вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования).*
...
Статья 189-1. Вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
...
1. Компетентный орган отказывает в выдаче лицензии при наличии одного из следующих оснований:
   ...
   8-1) вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII;
...
2. При выявлении нарушения компетентный орган письменно уведомляет об этом недропользователя.
   ...
   3) вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
...
1. Компетентный орган отказывает в выдаче лицензии на добычу твердых полезных ископаемых при наличии одного из следующих оснований:
   ...
   4-1) вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII;
...
10. Отзыв лицензии на добычу твердых полезных ископаемых является основанием для внесения сведений о соответствующем участке недр в единый кадастр государственного фонда недр.
    ...
    Глава 28-1. Вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
...
7-1. Вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.

7-2. Вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования в соответствии с Законом РК от 30.12.2025 № 249-VIII.
