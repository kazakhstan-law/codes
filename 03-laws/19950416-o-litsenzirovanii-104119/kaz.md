...
caused_by:
  code: '12699'
  title: '"Лицензиялау туралы" Қазақстан Республикасының Заңына толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/12699/kaz
source: https://zan.gov.kz/client/#!/doc/104119/kaz/09.07.2002
---
...
1. Лицензияның қолданылуы, тек мынадай жағдайларда:
   ...
   4) азаматтың кәсiпкерлiк қызметiнiң тоқтатылуы, заңды тұлғаның қайта ұйымдастырылуы немесе таратылуы.
