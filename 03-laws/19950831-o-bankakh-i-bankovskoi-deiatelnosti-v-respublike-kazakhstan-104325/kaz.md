...
caused_by:
  code: '133004'
  title: Қазақстан Республикасының кейбір заңнамалық актілеріне қаржы нарығын реттеу мен дамыту, микроқаржылық қызмет және салық салу мәселелері бойынша өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/133004/kaz
