...
caused_by:
  code: '156104'
  title: Қазақстан Республикасының кейбір заңнамалық актілеріне Қазақстан Республикасында банктік, микроқаржылық және коллекторлық қызметті реттеу мәселелері бойынша өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/156104/kaz
source: https://zan.gov.kz/client/#!/doc/104325/kaz/01.10.2021
---
