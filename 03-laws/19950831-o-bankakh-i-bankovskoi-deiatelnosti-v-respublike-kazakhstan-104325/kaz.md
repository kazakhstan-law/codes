...
caused_by:
  code: '192827'
  title: Қазақстан Республикасының кейбір заңнамалық актілеріне экспорттық-кредиттік агенттік және шикізаттық емес тауарлардың (жұмыстардың, көрсетілетін қызметтердің) экспортын ілгерілету мәселелері бойынша өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/192827/kaz
source: https://zan.gov.kz/client/#!/doc/104325/kaz/25.03.2024
---
