...
registry_number: '5'
source: https://zan.gov.kz/client/#!/doc/5/rus/22.12.1995
---
...
3. Предоставление права землепользования иностранным землепользователям осуществляется за плату.
...
5) выдачи разрешений на занятие земельных участков для проведения изыскательских работ согласно пункту 2 статьи 51 настоящего Указа;
