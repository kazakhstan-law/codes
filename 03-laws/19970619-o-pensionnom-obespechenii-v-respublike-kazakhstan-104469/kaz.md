...
caused_by:
  code: '64398'
  title: Зейнетақы активтер есебінен жинақтаушы зейнетақы қорының инвестициялық портфелінің құрылымы туралы мәліметтерді жинақтаушы зейнетақы қорларының бұқаралық ақпарат құралдарында жариялау қағидаларын бекіту туралы
  link: https://zan.gov.kz/client/#!/doc/64398/kaz
