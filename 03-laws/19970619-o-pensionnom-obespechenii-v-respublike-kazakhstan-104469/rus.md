...
caused_by:
  code: '42372'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам коллективного инвестирования и деятельности накопительных пенсионных фондов
  link: https://zan.gov.kz/client/#!/doc/42372/rus
source: https://zan.gov.kz/client/#!/doc/104469/rus/20.11.2008
---
...
2. Центр осуществляет:
   ...
   Предусмотрено изложить подпункт 4-2 статьи 18 в редакции Закона РК от 20.11.2008 N 88-IV (порядок введения в действие см. ст.2 ).

   4-2) перевод пенсионных накоплений вкладчиков из одного накопительного пенсионного фонда в другой;

   Примечание РЦПИ!

   Предусмотрено дополнить статью 18 подпунктами 4-3, 4-4 в соответствии с Законом РК от 20.11.2008 N 88-IV (порядок введения в действие см. ст.2 ).
...
В статью 30 предусмотрено изменение Законом РК от 20.11.2008 N 88-IV (порядок введения в действие см. ст.2 ).
...
4. Для соответствия требованию, предусмотренному подпунктом 2) пункта 2 настоящей статьи, необходимо наличие стажа работы:
   ...
   2) для кандидатов на должности членов правления накопительного пенсионного фонда не менее двух лет.

      Для кандидатов на должности первого руководителя и членов совета директоров наличие стажа работы, предусмотренного подпунктом 2) пункта 2 настоящей статьи не требуется.
...
5. Руководящий работник вправе занимать свою должность без согласования с уполномоченным органом не более шестидесяти календарных дней со дня его назначения (избрания).
   ...
   По истечении срока, указанного в настоящем пункте, и в случае непредставления полного пакета документов на согласование в уполномоченный орган либо в случае отказа уполномоченным органом в согласовании накопительный пенсионный фонд обязан расторгнуть трудовой договор с данным лицом.
