...
source: https://zan.gov.kz/client/#!/doc/104462/rus/21.01.2013
---
...
Статья 1 предусмотрена в редакции Закона РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
В статью 19 предусмотрено изменение Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
В статью 23 предусмотрено изменение Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
Статья 24 предусмотрена в редакции Закона РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
Главу 5 предусмотрено дополнить статьей 24-1 в соответствии с Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
2) разрабатывает программу функционирования и развития языков и иные нормативные правовые акты;
   ...
   В подпункт 3) предусмотрено изменение Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
5) организует информационное, методическое обеспечение деятельности по реализации единой государственной политики в сфере развития языков;
   ...
   Статью 25 предусмотрено дополнить подпунктом 5-1) в соответствии с Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).

   Примечание РЦПИ!

   В подпункт 6) предусмотрено изменение Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
8) осуществляет иные полномочия, предусмотренные настоящим Законом, иными законами Республики Казахстан, актами Президента Республики Казахстан и Правительства Республики Казахстан.
   ...
   Статья 25-1 предусмотрена в редакции Закона РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
3. Городские ономастические комиссии создаются:
   ...
   2) местными исполнительными органами города областного значения в целях подготовки и внесения следующих заключений о наименовании и переименовании: районов в городе, площадей, проспектов, бульваров, улиц, переулков, парков, скверов, мостов и других составных частей города, а также изменении транскрипции их названий. <*>
      ...
      В заголовок статьи 25-2 предусмотрено изменение Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
В абзац первый предусмотрено изменение Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
2) осуществляет контроль за соблюдением законодательства Республики Казахстан о языках территориальными подразделениями центральных исполнительных органов и районными исполнительными органами;
   ...
   Статью 25-2 предусмотрено дополнить подпунктом 2-1) в соответствии с Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).

   Примечание РЦПИ!

   Подпункт 3) предусмотрен в редакции Закона РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
3) дает рекомендации об устранении нарушений требований, установленных законодательством Республики Казахстан о языках, вносит предложения в соответствующие органы о применении мер дисциплинарного взыскания к должностным лицам, виновным в нарушении законодательства Республики Казахстан о языках;
   ...
   Статью 25-2 предусмотрено дополнить подпунктом 3-1) в соответствии с Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).

4) осуществляет комплекс мер областного значения, направленных на развитие государственного и других языков;

   Примечание РЦПИ!

   Подпункт 5) предусмотрен в редакции Закона РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).
...
Главу 5 предусмотрено дополнить статьей 25-5 в соответствии с Законом РК от 21.01.2013 № 72-V (вводится в действие по истечении трех месяцев после его первого официального опубликования).

Статья 26. Исключена Законом РК от 20.12.2004 N 13 (вводится в действие с 01.01.2005).
