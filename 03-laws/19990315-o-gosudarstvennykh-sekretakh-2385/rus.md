...
source: https://zan.gov.kz/client/#!/doc/2385/rus/15.07.2011
---
...
2) проводят специальную проверку граждан Республики Казахстан, оформляемых (переоформляемых) на допуск к сведениям, составляющим государственные секреты;
   ...
   Подпункт 3) предусмотрен в редакции Закона РК от 15.07.2011 № 461-IV (вводится в действие с 30.01.2012).
