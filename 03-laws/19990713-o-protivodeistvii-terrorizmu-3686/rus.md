...
caused_by:
  code: '142773'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам защиты материнства и детства
  link: https://zan.gov.kz/client/#!/doc/142773/rus
