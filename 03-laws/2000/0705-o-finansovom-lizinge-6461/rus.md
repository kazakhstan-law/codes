...
2. Перечень предметов лизинга, к которым применяется таможенный режим временного ввоза и временного вывоза товаров, установленный таможенным законодательством Республики Казахстан, определяется Правительством Республики Казахстан.
