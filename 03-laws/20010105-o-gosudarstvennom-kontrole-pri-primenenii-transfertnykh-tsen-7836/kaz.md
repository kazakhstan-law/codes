...
act_code: '7836'
language: kaz
title: Трансферттік бағаларды қолдану кезіндегі мемлекеттік бақылау туралы
requisite: Қазақстан Республикасының 2001 жылғы 5 қаңтардағы № 136 Заңы. Күші жойылды - Қазақстан Республикасының 2008 жылғы 5 шілдедегі № 67-IV (2009 жылғы 1 қаңтардан бастап қолданысқа енгізіледі) Заңымен
form: ЗАК
type_codes:
- ЗАК
approved_by:
