...
| [`ch003-part009`](rus/ch003-part009.md) | Статья 32-1. Порядок назначения на должность, освобождения от должности и прекращения полномочий акима района (города областного значения) |
