...
| [`ch003-part008`](rus/ch003-part008.md) | Статья 32. Порядок избрания на должность, освобождения от должности и прекращения полномочий акима района (города областного значения) |
