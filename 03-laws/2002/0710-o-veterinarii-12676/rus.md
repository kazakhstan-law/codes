...
7) ветеринарный контрольный пост - подразделение ведомства уполномоченного органа, расположенное на территории пограничных и таможенных пунктов (пунктов пропуска через Государственную границу Республики Казахстан, совпадающую с таможенной границей таможенного союза), оснащенное необходимым оборудованием и приборами, осуществляющее ветеринарно-санитарный контроль и надзор перемещаемых (перевозимых) объектов; P940748
   ...
   Подпункт 8) предусмотрен в редакции Закона РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011).
...
12) утверждение типового положения о подразделениях местных исполнительных органов, осуществляющих деятельность в области ветеринарии.
    ...
    Статью 5 предусмотрено дополнить пп. 13) - 19) в соответствии с Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
...
8) осуществление государственного закупа ветеринарных препаратов и услуг по их хранению, транспортировке (доставке) и использованию в порядке, установленном законодательством Республики Казахстан;
   ...
   Подпункт 9) предусмотрен в редакции Закона РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011).
...
29) определение порядка осуществления транспортировки (перемещений) перемещаемых (перевозимых) объектов на территории Республики Казахстан;
    ...
    В подпункт 30) предусмотрено изменение Законом РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011).
...
33) осуществление государственного ветеринарно-санитарного контроля и надзора за использованием, транспортировкой (доставкой), хранением и уничтожением используемых в области ветеринарии штаммов возбудителей болезней животных в организациях;
    ...
    В подпункт 34) предусмотрено изменение Законом РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011).
...
42) разработка порядка организации проведения убоя сельскохозяйственных животных, предназначенных для последующей реализации.
    ...
    Статью 8 предусмотрено дополнить пп. 43) - 47) в соответствии с Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
...
В статью 14 предусмотрены изменения Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
...
В статью 14-1 предусмотрены изменения Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
