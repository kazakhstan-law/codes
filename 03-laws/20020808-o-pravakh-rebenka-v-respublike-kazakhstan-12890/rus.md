...
caused_by:
  code: '73338'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам обеспечения прав на жилище детей-сирот, детей, оставшихся без попечения родителей
  link: https://zan.gov.kz/client/#!/doc/73338/rus
source: https://zan.gov.kz/client/#!/doc/12890/rus/04.07.2013
---
