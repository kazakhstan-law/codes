...
1. Транспортный контроль подразделяется на следующие виды:
   ...
   1) контроль за проездом автотранспортных средств по территории Республики Казахстан;
      ...
      В подпункт 2) предусмотрены изменения законами РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011); от 15.07.2011 № 461-IV (вводится в действие с 30.01.2012).
