...
source: https://zan.gov.kz/client/#!/doc/15348/rus/07.07.2006
---
...
21) цена размещения - цена акции, определяемая при размещении акций на первичном рынке ценных бумаг. <*>
    ...
    > *Сноска. В статью 1 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2)*
...
5. Решения учредительного собрания (единственного учредителя) оформляются протоколом, подлежащим подписанию всеми учредителями (единственным учредителем) общества. <*>
   ...
   > *Сноска. В статью 6 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2)*
...
1. Акционер общества обязан:
   ...
   2) в течение десяти дней извещать регистратора и номинального держателя акций, принадлежащих данному акционеру, об изменении сведений, необходимых для ведения системы реестров держателей акций общества;
...
2. Общество и регистратор не несут ответственности за последствия неисполнения акционером требования, установленного подпунктом 2) пункта 1 настоящей статьи. <*>
   ...
   > *Сноска. В статью 15 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2)*
...
4. В случае принятия органом общества, уполномоченным принимать решение о размещении объявленных акций, решения об увеличении количества размещаемых акций и (или) уменьшении цены размещения данное размещение производится с учетом положений пункта 1 статьи 16 настоящего Закона.
   ...
   > *Сноска. Статья 18 - в редакции Закона РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2). Внесены изменения - Законом РК от 5 июня 2006 года N 146 (порядок введения в действие см. ст.2 ).*
...
1. Выплата дивидендов по простым акциям общества по итогам квартала или полугодия может осуществляться по решению совета директоров, если это предусмотрено уставом общества.
   ...
   Указанные органы общества вправе принять решение о невыплате дивидендов по простым акциям общества с обязательным опубликованием его в средствах массовой информации в течение десяти рабочих дней со дня принятия решения.

2. В течение десяти рабочих дней со дня принятия решения о выплате дивидендов по простым акциям общества это решение должно быть опубликовано в средствах массовой информации.
...
3. Решение о выплате дивидендов по простым акциям общества должно содержать следующие сведения:
   ...
   5) порядок и форму выплаты дивидендов. <*>
      ...
      > *Сноска. В статью 23 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2).*
...
5. Решения, принимаемые советом директоров, подлежат согласованию с владельцем "золотой акции" по вопросам, в отношении которых установлено право вето. <*>
   ...
   > *Сноска. В статью 53 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2).*
...
6. Протоколы заседаний совета директоров и решения совета директоров, принятые путем заочного голосования, хранятся в архиве общества.
   ...
   > *Сноска. В статью 58 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2).*
...
2. Контролем над обществом или иным юридическим лицом является возможность определять решения, принимаемые соответственно обществом или иным юридическим лицом. <*>
   ...
   > *Сноска. В статью 64 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2).*
...
4. Общество обязано ежегодно публиковать в средствах массовой информации годовой бухгалтерский баланс, отчет, показывающий все изменения в капитале, отчет о движении денежных средств и отчет о доходах и расходах в сроки, установленные уполномоченным органом. Общество вправе дополнительно опубликовать иную финансовую отчетность. <*>

   > *Сноска. В статью 76 внесены изменения - Законом РК от 8 июля 2005 г. N 72 (порядок введения в действие см. ст.2).*
