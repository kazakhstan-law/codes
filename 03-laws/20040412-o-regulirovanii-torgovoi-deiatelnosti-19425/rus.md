...
caused_by:
  code: '46948'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам деятельности торгово-промышленных палат
  link: https://zan.gov.kz/client/#!/doc/46948/rus
source: https://zan.gov.kz/client/#!/doc/19425/rus/11.07.2009
---
...
10) осуществляет лицензирование экспорта и импорта отдельных товаров в порядке, установленном законодательством Республики Казахстан;
    ...
    Предусмотрено дополнить статью 7 подпунктом 10-1) в соответствии с Законом РК от 11.07.2009 N 184 (порядок введения в действие см. ст.2 ).
...
3. Плановые проверки проводятся не чаще одного раза в год.
   ...
   > *Сноска. Статья 33 в новой редакции - Законом Республики Казахстан от 31 января 2006 года N 125.*
