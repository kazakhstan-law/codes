---
version_id: AI26889_4
act_code: '26889'
language: kaz
title: Инновациялық қызметтi мемлекеттiк қолдау туралы
requisite: Қазақстан Республикасының 2006 жылғы 23 наурыздағы № 135 Заңы. Күші жойылды - Қазақстан Республикасының 2012 жылғы 9 қаңтардағы № 534-IV Заңымен
form: ЗАК
type_codes:
- ЗАК
approved_by:
...
caused_by:
  code: '45117'
  title: '"Инновациялық қызметті мемлекеттік қолдау туралы" Қазақстан Республикасының Заңына өзгерістер мен толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/45117/kaz
source: https://zan.gov.kz/client/#!/doc/26889/kaz/30.03.2009
---
