...
caused_by:
  code: '76603'
  title: Қазақстан Республикасының кейбір заңнамалық актілеріне мемлекеттік органдардың құзыретін заңнамалық және (немесе) заңға тәуелді деңгейде бекіту мәселелері бойынша өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/76603/kaz
