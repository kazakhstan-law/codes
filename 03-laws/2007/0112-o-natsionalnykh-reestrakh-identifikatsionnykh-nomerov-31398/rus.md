...
4. Идентификационный номер применяется при: V075021
...
3. Документами с индивидуальным идентификационным номером являются: V075021
   ...
   3) свидетельство налогоплательщика для иностранцев и лиц без гражданства в случае отсутствия документов Республики Казахстан, удостоверяющих личность.
...
4. Документами с бизнес-идентификационным номером являются:
   ...
   4) свидетельство налогоплательщика Республики Казахстан - для юридических лиц-нерезидентов, указанных в подпунктах 5-1), 6) и 7) пункта 1 статьи 521 Кодекса Республики Казахстан "О налогах и других обязательных платежах в бюджет" (Налогового кодекса).
...
6. Формирование индивидуального идентификационного номера осуществляется:
   ...
   3) для лиц без гражданства при выдаче удостоверения лица без гражданства или свидетельства налогоплательщика, выдаваемого в соответствии с подпунктом 3) пункта 3 настоящей статьи.
...
8. Формирование бизнес-идентификационного номера осуществляется:
   ...
   4) для юридических лиц-нерезидентов, указанных в подпунктах 5-1), 6) и 7) пункта 1 статьи 521 Кодекса Республики Казахстан "О налогах и других обязательных платежах в бюджет" (Налогового кодекса), при регистрации в качестве налогоплательщика.
...
10. Регистрация либо прием обращений физических и юридических лиц (филиалов и представительств) для формирования идентификационного номера осуществляется :
    ...
    5) по месту регистрации резидента-эмитента или юридического лица-резидента, имущество которого составляет более пятидесяти процентов стоимости реализованных акций, долей участия или активов юридического лица-нерезидента:
...
1. Настоящий Закон вводится в действие со дня его официального опубликования, за исключением подпунктов 4) и 5) пункта 4 статьи 3, части второй пункта 5 статьи 9 настоящего Закона, которые вводятся в действие по истечении трех лет шести месяцев со дня введения в действие настоящего Закона.
...
3. Документы, перечисленные в пунктах 3 и 4 статьи 9 настоящего Закона, за исключением свидетельств о рождении, признаются недействительными в случае отсутствия в них сформированного идентификационного номера по истечении трех лет с момента истечения срока, предусмотренного пунктом 2 настоящей статьи.

   До истечения трех лет шести месяцев со дня введения настоящего Закона используются идентификационный код Общего классификатора предприятий и организаций, регистрационный номер налогоплательщика, социальный индивидуальный код.
