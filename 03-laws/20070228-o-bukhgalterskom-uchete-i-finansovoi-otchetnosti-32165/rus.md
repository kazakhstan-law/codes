...
caused_by:
  code: '101454'
  title: О внесении изменений и дополнений в некоторые законодательные акты Республики Казахстан по вопросам регулирования зернового рынка
  link: https://zan.gov.kz/client/#!/doc/101454/rus
source: https://zan.gov.kz/client/#!/doc/32165/rus/09.04.2016
---
...
Подпункт 7) предусмотрен в редакции Закона РК от 09.04.2016 № 502-V (вводится в действие по истечении трех месяцев со дня его первого официального опубликования).
