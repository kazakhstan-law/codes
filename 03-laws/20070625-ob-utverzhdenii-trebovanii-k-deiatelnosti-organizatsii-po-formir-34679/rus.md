...
4. Для регистрации в Организации поставщики информации, указанные в пункте 5 статьи 8-1 Закона, и получатели страхового отчета, указанные в подпунктах 2) и 4) пункта 8 статьи 8-1 Закона, представляют следующие документы:
   ...
   4) информацию о фамилии, имени, при наличии - отчестве и должности лиц, уполномоченных осуществлять запросы в Организацию в порядке, определенном Организацией. При необходимости указанная информация удостоверяется электронной цифровой подписью этих лиц.
      ...
      > *Сноска. Пункт 4 с изменениями, внесенными постановлением Правления Агентства РК по регулированию и надзору финансового рынка и финансовых организаций от 01.03.2010 № 23 (порядок введения в действие см. п. 4).*
...
7. Предоставление Организацией получателям страхового отчета, указанным в подпунктах 1), 3), 5), 6), 7) пункта 8 статьи 8-1 Закона, осуществляется на основании их запроса на бумажном или электронном носителях.

   > *Сноска. Пункт 7 с изменениями, внесенными постановлением Правления Агентства РК по регулированию и надзору финансового рынка и финансовых организаций от 01.03.2010 № 23 (порядок введения в действие см. п. 4).*
...
11. Поставщик информации, указанный в подпункте 1) пункта 5 статьи 8-1 Закона, представляет в Организацию сведения, предусмотренные пунктом 2 статьи 8-2 Закона, о владельцах транспортных средств, указанных в подпунктах 1) и 3) пункта 1 статьи 5 Закона, в режиме реального времени, к которым относятся:

    1) вид договора страхования в соответствии с пунктом 4 статьи 10 Закона;

    2) номер и дата выдачи страхового полиса;
    ...
    3) сведения о заявителе:
       ...
       регистрационный номер налогоплательщика или индивидуальный идентификационный номер (для физического лица) либо бизнес-идентификационный номер (для юридического лица);

       код сектора экономики;

       признак резидентства (резидент/нерезидент Республики Казахстан);

    4) сведения об автотранспортном средстве (в случае заключения комплексного договора страхования указываются сведения о каждой единице транспортного средства):

       место регистрации;

       номер и дата выдачи свидетельства о регистрации транспортного средства (для резидентов Республики Казахстан) или иного документа, подтверждающего регистрацию транспортного средства (для нерезидентов Республики Казахстан);
       ...
       номер кузова (идентификационный номер (VIN));

       цвет кузова (кабины);

    5) сведения о сроке страхования;

    6) сведения о льготах, представляемых страхователю (для физического лица):
    ...
    7) сведения о семейном положении страхователя;

    8) сведения о застрахованном (застрахованных):
    ...
    9) сведения о двойном страховании, сезонной эксплуатации транспортного средства, временном въезде на территорию Республики Казахстан;

    10) дата подписания заявления;

    11) сведения по страховым случаям (при наличии):

        дата принятия заявления от страхователя (застрахованного) о наступлении страхового случая, представленного в соответствии с требованиями подпункта 3) пункта 2 статьи 16 Закона;

        дата принятия и вступления в законную силу постановления судьи (суда), органа (должностного лица), рассмотревшего дело об административном правонарушении, либо судебный акт, подтверждающий наличие вины страхователя (застрахованного) и (или) свидетельствующий о причинении вреда жизни, здоровью или имуществу потерпевшего (потерпевших);

        сумма страховой выплаты по возмещению вреда, причиненного имуществу потерпевшего (потерпевших);

        сумма страховой выплаты по возмещению вреда, причиненного жизни и (или) здоровью потерпевшего (потерпевших);

        расходы, связанные с проведением оценки;

        расходы страховщика на ведение дела;

        расходы страхователя (застрахованного), понесенные им в целях предотвращения или уменьшения убытков при страховом случае;

        иные расходы.

        > *Сноска. Пункт 11 в редакции постановления Правления Агентства РК по регулированию и надзору финансового рынка и финансовых организаций от 01.03.2010 № 23 (порядок введения в действие см. п. 4).*
...
12. Сведения о страхователе (застрахованном), транспортном средстве, представляемые в Организацию поставщиком информации, должны соответствовать сведениям, указанным в заявлении страхователя, предусмотренном пунктом 5 статьи 10 Закона.

    > *Сноска. Пункт 12 в редакции постановления Правления Агентства РК по регулированию и надзору финансового рынка и финансовых организаций от 01.03.2010 № 23 (порядок введения в действие см. п. 4).*
...
13. Структура базы данных определяется Организацией по согласованию с поставщиком информации с учетом требований, установленных Законом, которая обеспечивает выполнение следующих основных функций базы данных:
    ...
    3\) присвоение уникального номера страховому полису.
    ...
    > *Сноска. Пункт 13 в редакции постановления Правления Агентства РК по регулированию и надзору финансового рынка и финансовых организаций от 01.03.2010 № 23 (порядок введения в действие см. п. 4).*
