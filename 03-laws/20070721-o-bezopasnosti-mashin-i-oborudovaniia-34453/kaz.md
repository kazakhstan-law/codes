---
version_id: AI34453_0
act_code: '34453'
language: kaz
title: Машиналар мен жабдықтардың қауіпсіздігі туралы
requisite: Қазақстан Республикасының 2007 жылғы 21 шілдедегі № 305 Заңы
form: ЗАК
type_codes:
- ЗАК
approved_by:
...
registry_number: '34453'
source: https://zan.gov.kz/client/#!/doc/34453/kaz/21.07.2007
---
...
Қолданушылар назарына! Осы Заң 2008 жылғы 1 қаңтардан бастап қолданысқа енгізіледі.
...
7) осы Заңда және техникалық регламенттерде белгіленген қауіпсіздік талаптарына сай келмейтін машиналар мен жабдықтарды жасауды, өткізуді және олардың нарықтағы айналысын тоқтата тұру туралы нұсқама беру жатады.
...
1. Уәкілетті органдар машиналар мен жабдықтардың қауіпсіздігі саласындағы мемлекеттік бақылауды және қадағалауды Қазақстан Республикасының заңнамалық актілерінде белгіленген тәртіппен әрі өз құзыреті шегінде жүзеге асырады.

2. Машиналар мен жабдықтардың қауіпсіздігі саласындағы мемлекеттік бақылау және қадағалау жоспарлы және жоспардан тыс тексерулер түрінде жүзеге асырылады.

3. Жоспарлы тексеру жылына бір реттен жиі өткізілмейді.

4. Машиналар мен жабдықтардың қауіпсіздігін қамтамасыз ететін уәкілетті орган:

   1) осы Заңда және техникалық регламенттерде белгіленген қауіпсіздік талаптарының бұзылуына байланысты машиналардың, жабдықтардың авариялары және істен шығу фактілері туралы;

   2) адам өмірі мен денсаулығына, қоршаған ортаға зиян келу фактілері туралы;

   3) машиналардың және (немесе) жабдықтардың қауіпсіздік талаптарының бұзылу фактілері туралы ақпарат алған жағдайда, жоспардан тыс тексеру жүргізеді.

5. Машиналар мен жабдықтардың қауіпсіздігі саласындағы тексеру екі кезеңде жүргізіледі:

   1) құжаттық тексеру;

   2) қатерлерді бағалауды тексеру.

6. Машиналар мен жабдықтардың қауіпсіздігі саласындағы құжаттық тексеру:

   1) пайдалану жөніндегі нұсқаулықтағы пайдаланушыға арналған ақпараттың дұрыстығын және осы Заңның, техникалық регламенттердің талаптарына сәйкестігін тексеру;

   2) қауіпсіздік паспортындағы және сәйкестікті растау саласындағы құжаттардағы ақпараттың сәйкестігін тексеру жолымен жүзеге асырылады.

      Машиналар мен жабдықтардың жекелеген түрлері үшін қауіпсіздік паспорттарының мазмұнын техникалық регламенттерде белгіленеді.

7. Қатерлердің бағалануын тексеру кезінде уәкілетті орган машиналар мен жабдықтарды немесе олардың жекелеген бөлшектерін техникалық реттеу саласындағы аккредиттеу жөніндегі орган аккредиттеген сынақ зертханасына (орталығына) сынақтар (зерттеулер) жүргізу үшін жібереді.

8. Қатерді бағалау бағдарламасын уәкілетті орган әзірлейді.
