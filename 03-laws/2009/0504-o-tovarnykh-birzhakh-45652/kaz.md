...
8) Қазақстан Республикасының тауар биржалары туралы заңнамасының сақталуына мемлекеттік бақылауды жүзеге асырады;
...
3. Тауар биржасында коммерциялық құпияны құрайтын мәліметтер:
   ...
   5) уәкілетті органға: оның сұрау салуы бойынша өз құзыреті шегінде берілуге тиіс.
...
1. Тауар биржаларының қызметін тексеру осы Заңға және Қазақстан Республикасының өзге де заңдарына сәйкес жүзеге асырылады.

2. Уәкілетті орган жүзеге асыратын тауар биржаларының қызметін тексеру жоспарлы және жоспардан тыс болуы мүмкін.

3. Тауар биржаларының қызметін жоспарлы тексеруді уәкілетті орган жылына бір реттен жиі жүргізбейді.

   Уәкілетті органның басшысы жыл сайын бекітетін уәкілетті органның жұмыс жоспары жоспарлы тексеру жүргізу үшін негіз болып табылады. Жоспарда өздеріне қатысты тексерулер жүргізу көзделіп отырған тауар биржаларының тізбесі және оларды жүргізу кезеңі қамтылуға тиіс.

4. Тауар биржаларының қызметіне уәкілетті органның жоспардан тыс тексеру жүргізуіне:
   ...
   4) бұқаралық ақпарат құралдарының хабарламалары негіз болып табылады.
...
5. Осы баптың 4-тармағында көзделген негіздер туындаған күннен бастап күнтізбелік он күннен кешіктірмей, уәкілетті орган:
   ...
   2) Қазақстан Республикасының тауар биржалары туралы заңнамасын бұзушылық фактілеріне негіздер болмауына орай тексеру жүргізуден бас тартады.

<a id="st26"></a>

### 26-бап. Тауар биржаларының қызметіне тексеру жүргізудің тәртібі

1. Тауар биржаларының қызметін тексеру уәкілетті органның тексеруді тағайындау туралы актісі негізінде жүргізіледі. Тексеруді тағайындау туралы актіде:

   1) уәкілетті органның атауы;

   2) тексеруді тағайындау туралы актінің шығарылған күні мен тіркеу нөмірі;

   3) тексеру жүргізуге уәкілетті адамның (адамдардың) тегі, аты, әкесінің аты (ол болған ретте), лауазымы;

   4) салық төлеушінің - тауар биржасының атауы, орналасқан жері және сәйкестендіру нөмірі;
   ...
   9) егер тауар биржалары қызметінің белгілі бір уақыт кезеңіндегі құжаттарын зерделеу қажет болған жағдайда тексерілетін кезең;

   10) тауар биржаларының қызметіне тексеру жүргізудің негізгі міндеттері мен мақсаттары көрсетіле отырып, тексеру бағдарламасы, тауар биржаларының қызметін тексеру барысында анықталуға жататын мәселелер тізбесі мен мән-жайлар шеңбері қамтылуға тиіс.

2. Уәкілетті органның тексеруді тағайындау туралы актісіне уәкілетті органның басшысы не оның міндетін атқарушы адам қол қояды және ол уәкілетті органның мөрімен расталады.

3. Тексеруді тағайындау туралы акт Қазақстан Республикасының заңнамасында белгіленген тәртіппен құқықтық статистика және арнайы есепке алу саласындағы статистикалық қызметті өз құзыреті шегінде жүзеге асыратын мемлекеттік органда (бұдан әрі - құқықтық статистика органы) міндетті түрде тіркеледі.

4. Тауар биржаларының қызметіне тексеру жүргізу кезінде уәкілетті органның лауазымды адамы тауар биржасының басшысына немесе оны алмастыратын адамға:

   1) құқықтық статистика органында тіркелгені туралы белгі қойылған тексеруді тағайындау туралы актіні;

   2) қызметтік куәлігін;

   3) уәкілетті органның басшысы бекіткен тексеру жоспарын көрсетуге міндетті.

5. Тексеруді тағайындау туралы актіні және қызметтік куәлікті көрсеткен кезде тауар биржасының басшысы немесе оны алмастыратын адам уәкілетті органның лауазымды адамын өздеріне тиесілі аумаққа немесе үй-жайға жіберуге және тексерілетін тауар биржаларының лауазымды адамдарынан, басшылары мен басқа да қызметкерлерінен тексеру жүргізуге қажетті ақпаратты, құжаттарды сұрату мен оларды алу және тексеру барысында туындаған мәселелер бойынша ауызша және жазбаша түрде түсініктемелер алу мүмкіндігін қамтамасыз етуге міндетті.

6. Уәкілетті органның лауазымды адамының тексеру кезінде тауар биржасының немесе брокердің және (немесе) дилердің жүргізілетін тексеру нысанасына қатысы жоқ немесе актіде көрсетілген кезеңге қатысы жоқ қандай да бір құжаттарын немесе материалдарын алып қоюына, тауар биржалары және биржалық саудаға қатысушылар туралы тексеру процесінде алынған ақпаратты жария етуіне тыйым салынады.

7. Тексеруді тағайындау туралы актіні қабылдаудан бас тартқан немесе уәкілетті органның тексеруді жүзеге асыратын лауазымды адамдарының тексеру жүргізуге қажетті материалдарға қол жеткізуіне кедергі келтірілген жағдайда хаттама жасалады. Хаттамаға тексеруді жүзеге асыратын уәкілетті органның лауазымды адамы және тексерілетін тауар биржасының уәкілетті адамы қол қояды.
...
8. Тауар биржасының қызметіне тексеру жүргізу мерзімі алда тұрған жұмыстардың және қойылған міндеттердің көлемін ескере отырып белгіленеді, бірақ ол күнтізбелік отыз күннен аспауға тиіс.

   Мән-жайларды қосымша тексеру қажет болған жағдайда тексеру жүргізу мерзімі уәкілетті органның шешімімен күнтізбелік отыз күнге ұзартылуы мүмкін.

   Тауар биржасының қызметін тексеру мерзімін ұзартуды уәкілетті органның басшысы не оның міндетін атқарушы адам жүргізеді.

   Тексеру мерзімі ұзартылған жағдайда уәкілетті орган міндетті түрде құқықтық статистика органында тіркей отырып, тексеруді ұзарту туралы қосымша актіні ресімдейді, онда тексеруді тағайындау туралы алдыңғы актінің нөмірі мен тіркелген күні және ұзарту себебі көрсетіледі.

   Тексеруді тағайындау туралы бір актінің негізінде бір ғана тексеру жүргізіледі.

9. Уәкілетті органның тексерулерге басқа мемлекеттік органдардың қызметкерлерін тартуға құқығы бар.

10. Тексеру тауар биржасының қызметін тексеру қорытындылары туралы екі дана етіп анықтама жасаумен аяқталады.

    Тексеру қорытындылары туралы анықтамаға тауар биржасының қызметін тексеруді жүзеге асыратын лауазымды адам және тексерілетін тауар биржасының басшысы немесе оны алмастыратын адам қол қояды.

11. Тексерілетін тауар биржасының басшысы немесе оны алмастыратын адам ерекше пікірін жазбаша түрде білдіруге құқылы, ол тексеру қорытындылары туралы анықтамаға қоса беріледі.

12. Тексерілетін тауар биржасының басшысы немесе оны алмастыратын адам тексеру қорытындылары туралы анықтамаға қол қоюдан бас тартқан жағдайда, тауар биржасының қызметін тексеруді жүзеге асыратын лауазымды адам тексеру қорытындылары туралы анықтамаға тиісті жазба енгізеді.

13. Тексеру қорытындылары туралы анықтаманың екінші данасы тауар биржасының қызметін тексеру аяқталғаннан кейін қол қойғызып алу арқылы тауар биржасының басшысына немесе оны алмастыратын адамға, ал ол болмаған жағдайда тексерілетін тауар биржасының кеңсесіне анықтаманы қабылдап алған тауар биржасы қызметкерінің тегін және лауазымын көрсете отырып, қол қойғызу арқылы тапсырылады. Тексеру қорытындылары туралы анықтаманы беру не кеңсеге тапсыру мүмкін болмаған жағдайда, тексеру қорытындылары туралы анықтама тауар биржасына оның тапсырылғандығы туралы почта растамасы бар тапсырыс хатпен жіберіледі.

14. Тауар биржасының қызметін тексерудің нәтижелеріне Қазақстан Республикасының заңнамасында белгіленген тәртіппен шағым жасалуы мүмкін.
