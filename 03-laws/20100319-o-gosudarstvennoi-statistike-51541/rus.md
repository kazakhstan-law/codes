...
source: https://zan.gov.kz/client/#!/doc/51541/rus/08.06.2015
---
...
4. Не являются конфиденциальными следующие сведения, содержащиеся в базах данных, формируемых уполномоченным органом:
   ...
   6) код по классификатору размерности предприятий по численности занятых.
      ...
      В пункт 5 предусмотрено изменение Законом РК от 08.06.2015 № 317-V (вводится в действие по истечении тридцати календарных дней после дня его первого официального опубликования).
