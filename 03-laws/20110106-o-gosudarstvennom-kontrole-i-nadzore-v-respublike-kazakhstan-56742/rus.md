...
source: https://zan.gov.kz/client/#!/doc/56742/rus/21.07.2011
---
...
2. При проведении иных форм контроля и надзора не требуются предварительное уведомление проверяемого субъекта, а также регистрация в уполномоченном органе по правовой статистике и специальным учетам.
   ...
   Статью 10 предусмотрено дополнить п. 3 в соответствии с Законом РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011).
...
2. Предметом проверки является соблюдение проверяемыми субъектами требований, установленных законодательством Республики Казахстан в соответствии со статьей 5 настоящего Закона.
   ...
   В пункт 3 предусмотрены изменения Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
...
В статью 16 предусмотрены изменения Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
...
> *Сноска. Приложение с изменениями, внесенными законами РК от 26.01.2011 № 400-IV (вводится в действие по истечении тридцати календарных дней после его первого официального опубликования); от 21.07.2011 № 470-IV (вводится в действие по истечении десяти календарных дней после его первого официального опубликования).*
...
Пункт 1 предусмотрено дополнить пп. 93) - 96) в соответствии с Законом РК от 05.07.2011 № 452-IV (вводятся в действие с 13.10.2011).
...
2. Государственный надзор осуществляется:
   ...
   8) в области ветеринарии;
      ...
      В подпункт 9) предусмотрено изменение Законом РК от 05.07.2011 № 452-IV (вводится в действие с 13.10.2011).
