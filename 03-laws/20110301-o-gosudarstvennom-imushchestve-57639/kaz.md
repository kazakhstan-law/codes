...
source: https://zan.gov.kz/client/#!/doc/57639/kaz/01.03.2016
---
...
2. Шаруашылық жүргізу құқығындағы мемлекеттік кәсіпорындар өз қызметін:
   ...
   25) метрополитенді пайдалану (күтіп-ұстау, дамыту), сондай-ақ метрополитенмен жолаушылар мен багаж тасымалын іске асыру саласында жүзеге асырады.
