---
version_id: AI71655_1
act_code: '71655'
language: rus
title: О ратификации Устава Международного агентства по возобновляемой энергии (ИРЕНА)
requisite: Закон Республики Казахстан от 22 марта 2013 года № 82-V ЗРК
form: ЗАК
type_codes:
- ЗАК
- УСТ
...
source: https://zan.gov.kz/client/#!/doc/71655/rus
---
...
### Статья V Программа работы и проекты
...
### Статья XIII Правосубъектность, привилегии и иммунитеты
...
### Статья XIV Взаимоотношения с другими организациями
...
### Статья XV Поправки, выход, пересмотр
...
### Статья XVII Временное приостановление прав
...
### Статья XVIII Местонахождение Агентства

Местонахождение Агентства будет определено Ассамблеей на ее первой сессии.

<a id="stxix"></a>

### Статья XIX Подписание, ратификация, вступление в силу
...
### Статья XX Депозитарий, регистрация, аутентичный текст
