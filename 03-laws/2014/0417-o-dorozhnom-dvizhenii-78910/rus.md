...
В статье 1 предусмотрено изменение Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
25) осуществляет иные полномочия, предусмотренные настоящим Законом, иными законами Республики Казахстан, актами Президента Республики Казахстан и Правительства Республики Казахстан.
    ...
    В статье 11 предусмотрено изменение Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
6. В целях обеспечения безопасности передвижения автомобилей особого назначения Служба государственной охраны Республики Казахстан в городах Астане и Алматы, а в других административно-территориальных единицах органы национальной безопасности вправе определять скорость и маршруты их передвижения по автомобильным дорогам или отдельным участкам автомобильных дорог (специальным трассам) и вводить на них ограничения по передвижению, остановке и стоянке транспортных средств, временно изменять направления дорожного движения.
   ...
   > *Сноска. Статья 25 с изменениями, внесенными Законом РК от 04.07.2014 № 233-V (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
2. Схемы территориально-транспортного планирования, генеральные планы населенных пунктов должны предусматривать:
   ...
   4) наличие парковок, паркингов, велосипедных полос движения либо велосипедных дорожек, а также полос движения, предназначенных для общественного транспорта и специальных транспортных средств организаций скорой медицинской помощи и противопожарной службы;
...
1) учета всех видов транспортных средств при строительстве новой инфраструктуры, в том числе обеспечения дорог и улиц интеллектуальными транспортными системами, велосипедными полосами движения либо велосипедными дорожками, полосами движения, предназначенными для общественного транспорта;
...
8. Гарантийные обязательства распространяются на транспортное средство, его составные части в пределах произведенных работ, оговоренных в договоре между владельцем транспортного средства и исполнителем работ и услуг.
   ...
   В статье 51 предусмотрены изменения Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
1. Эксплуатация транспортных средств запрещается в случаях:
   ...
   2) отсутствия регистрации и учета лица, управляющего транспортным средством, переданным ему физическим лицом во временное владение и пользование;
   ...
   5) непрохождения обязательного технического осмотра, за исключением транспортных средств категории M1, возраст которых не превышает четырех лет, включая год выпуска, не используемых в предпринимательской деятельности в сфере автомобильного транспорта;
...
5. Участникам дорожного движения запрещается:
   ...
   4) допускать загрязнение окружающей среды.
      ...
      В статье 54 предусмотрены изменения Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
> *Сноска. Статья 54 с изменением, внесенным Законом РК от 04.07.2014 № 233-V (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
В статье 60 предусмотрено изменение Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
Пункт 1 предусмотрено дополнить подпунктами 11) и 12) в соответствии с Законом РК от 28.11.2014 № 257 (вводится в действие с 01.01.2015).
...
3. Виды правонарушений, влекущих в качестве меры ответственности лишение права на управление транспортными средствами либо ограничение такого права, устанавливаются законами Республики Казахстан.
   ...
   Статью 76 предусмотрено исключить Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
1. Регистрация и учет лиц, которым транспортные средства переданы во временное владение и пользование, осуществляются с использованием информационных систем в порядке, установленном уполномоченным органом.
   ...
   Регистрация и учет лиц, которым транспортные средства переданы во временное владение и пользование, осуществляются уполномоченным органом вне зависимости от места жительства владельца и регистрации транспортного средства.
...
3. Запрещается управление транспортным средством лицом, которому данное транспортное средство передано во временное владение и пользование, без его регистрации и учета.
   ...
   > *Сноска. Статья 76 с изменением, внесенным Законом РК от 29.09.2014 № 239-V (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
В статье 88 предусмотрены изменения Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
5. Основаниями для исключения из реестра операторов технического осмотра являются:
   ...
   5) совершение повторного в течение года административного правонарушения в сфере осуществления обязательного технического осмотра транспортных средств.
      ...
      В статье 90 предусмотрено изменение Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
1. Для получения международного сертификата технического осмотра владелец механического транспортного средства и прицепов к нему обращается в местный исполнительный орган с заявлением и приложением следующих документов:
   ...
   2) подтверждающих уплату физическими лицами налога на транспортные средства за текущий календарный год в порядке, установленном Кодексом Республики Казахстан «О налогах и других обязательных платежах в бюджет» (Налоговый кодекс), или право на освобождение от его уплаты;
...
8. Международный сертификат технического осмотра выдается на срок, соответствующий сроку, указанному в диагностической карте технического осмотра.
   ...
   В статье 91 предусмотрено изменение Законом РК от 29.12.2014 № 269-V (вводится в действие с 01.01.2015).
...
1. Операторы технического осмотра обязаны:
   ...
   9) составлять график проведения обязательного технического осмотра в пределах региона деятельности с согласия местных исполнительных органов;
