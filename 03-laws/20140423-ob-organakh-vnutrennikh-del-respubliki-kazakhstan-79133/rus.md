...
source: https://zan.gov.kz/client/#!/doc/79133/rus/08.06.2024
---
...
2. Министр внутренних дел:
   ...
   3-1) назначает на должность начальника департамента полиции области, города республиканского значения, столицы из числа сотрудников полиции, состоящих в Президентском резерве руководства правоохранительных органов Республики Казахстан;
