...
> *Сноска. По всему тексту слова «объектов информатизации», «объектах информатизации», «объекты информатизации» заменить соответственно словами «цифровых объектов», «цифровых объектах», «цифровые объекты» в соответствии с Законом РК от 09.01.2026 № 256-VIII (вводится в действие по истечении шести месяцев после дня его первого официального опубликования).*
...
4) официальное получение информации – получение информации, имеющей значение для решения задач контрразведывательной деятельности, путем непосредственного изучения документов, материалов, цифровых ресурсов, направления запросов физическим и юридическим лицам, которые располагают или могут располагать указанной информацией;

5) оперативный мониторинг сети связи и цифровых объектов – негласное обнаружение признаков разведывательно-подрывной деятельности в информации, передаваемой по сети связи или обрабатываемой на цифровых объектах;
...
> *Сноска. Статья 1 с изменениями, внесенными законами РК от 02.01.2021 № 399-VI (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования); от 05.07.2024 № 115-VIII (вводится в действие по истечении шести месяцев после дня его первого официального опубликования); от 09.01.2026 № 256-VIII (вводится в действие по истечении шести месяцев после дня его первого официального опубликования).*
...
1. К контрразведывательным мероприятиям относятся:
   ...
   11) оперативный мониторинг сети связи и цифровых объектов;
...
1. Для решения задач, предусмотренных настоящим Законом, орган, осуществляющий контрразведывательную деятельность, создает, эксплуатирует, развивает цифровые объекты, обеспечивает их безопасность, а также ведет контрразведывательные дела.

2. Порядок создания, развития, эксплуатации и обеспечения безопасности цифровых объектов органа, осуществляющего контрразведывательную деятельность, определяется законодательством Республики Казахстан.
