---
version_id: '186993_720613'
act_code: '186993'
language: kaz
title: 1999 жылғы 1 шілдедегі Қазақстан Республикасы Азаматтық кодексінің (Ерекше бөлім) 951-бабы 2-тармағының және Қазақстан Республикасы Жоғарғы Сотының «Соттардың моральдық зиянды өтеу жөніндегі заңнаманы қолдануы туралы» 2015 жылғы 27 қарашадағы № 7 нормативтік қаулысының 9-тармағының Қазақстан Республикасының Конституциясына сәйкестігін қарау туралы
requisite: Қазақстан Республикасы Конституциялық Сотының 2023 жылғы 6 қазандағы № 32-НҚ нормативтік қаулысы
form: НПОС
type_codes:
- НПОС
approved_by:
...
registry_number: '186993'
source: https://zan.gov.kz/client/#!/doc/186993/kaz
---
