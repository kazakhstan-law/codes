---
version_id: '192235_680891'
act_code: '192235'
language: kaz
title: 2020 жылғы 29 маусымдағы Қазақстан Республикасы Әкімшілік рәсімдік-процестік кодексінің 124-бабы екінші бөлігінің, 127-бабы тоғызыншы бөлігінің және 171-бабы төртінші бөлігінің Қазақстан Республикасының Конституциясына сәйкестігін қарау туралы
requisite: Қазақстан Республикасы Конституциялық Сотының 2024 жылғы 10 қаңтардағы № 40-НҚ нормативтік қаулысы
form: НПОС
type_codes:
- НПОС
approved_by:
...
source: https://zan.gov.kz/client/#!/doc/192235/kaz
---
