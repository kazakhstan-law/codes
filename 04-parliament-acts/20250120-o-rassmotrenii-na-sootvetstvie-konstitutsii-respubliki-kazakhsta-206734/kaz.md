---
version_id: '206734_742757'
act_code: '206734'
language: kaz
title: Қазақстан Республикасында бейбіт жиналыстарды ұйымдастыру және өткізу тәртібі туралы» 2020 жылғы 25 мамырдағы Қазақстан Республикасы Заңының 11-бабы 1-тармағы бірінші бөлігі 2) мен 3) тармақшаларының және 14-бабы 1-тармағы 10) тармақшасының Қазақстан Республикасының Конституциясына сәйкестігін қарау туралы
requisite: Қазақстан Республикасы Конституциялық Сотының 2025 жылғы 20 қаңтардағы № 61-НҚ нормативтік қаулысы
form: НПОС
type_codes:
- НПОС
approved_by:
...
source: https://zan.gov.kz/client/#!/doc/206734/kaz
---
