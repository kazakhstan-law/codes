---
version_id: '211020_771114'
act_code: '211020'
language: kaz
title: Қылмыстық істерді кассациялық тәртіппен қарауды регламенттейтін заңнаманы қолдану туралы
requisite: Қазақстан Республикасы Жоғарғы Сотының 2025 жылғы 29 мамырдағы № 1 Нормативтік қаулысы
form: НПОС
type_codes:
- НПОС
approved_by:
...
source: https://zan.gov.kz/client/#!/doc/211020/kaz
---
