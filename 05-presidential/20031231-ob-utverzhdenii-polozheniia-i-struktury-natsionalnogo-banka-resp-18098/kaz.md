...
caused_by:
  code: '216062'
  title: «Қазақстан Республикасы Ұлттық Банкiнiң ережесiн және құрылымын бекiту туралы» Қазақстан Республикасы Президентінің 2003 жылғы 31 желтоқсандағы № 1271 Жарлығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/216062/kaz
