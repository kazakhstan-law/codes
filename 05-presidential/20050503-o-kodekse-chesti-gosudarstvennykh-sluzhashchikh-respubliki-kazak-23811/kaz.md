...
caused_by:
  code: '74782'
  title: '"Қазақстан Республикасы мемлекеттік қызметшілерінің ар-намыс кодексі туралы" Қазақстан Республикасы Президентінің 2005 жылғы 3 мамырдағы № 1567 Жарлығына өзгерістер енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/74782/kaz
