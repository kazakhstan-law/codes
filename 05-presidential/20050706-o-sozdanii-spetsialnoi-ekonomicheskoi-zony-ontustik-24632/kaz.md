---
version_id: AI24632_6
act_code: '24632'
language: kaz
title: '"Оңтүстік" арнайы экономикалық аймағын құру туралы'
requisite: Қазақстан Республикасы Президентінің 2005 жылғы 6 шілдедегі № 1605 Жарлығы
form: УКАЗ
type_codes:
- УКАЗ
approved_by:
...
caused_by:
  ...
  link: https://zan.gov.kz/client/#!/doc/81887/kaz
source: https://zan.gov.kz/client/#!/doc/24632/kaz/31.07.2014
---
...
4. АЭА аумағындағы басым қызмет түрлері:

   1) киімнен басқа, дайын тоқыма бұйымдары өндірісі;

   2) өзге де тоқылған және трикотаж бұйымдары өндірісі;

   3) үлбірден және теріден тігілетін киімді қоспағанда, киім өндірісі;

   4) иірілген, тоқылған және әрлендірілген бұйымдар өндірісі;

   5) киімнен басқа, тоқыма емес бұйымдар өндірісі;

   6) кілемдер мен кілем бұйымдары өндірісі;

   7) ағаш ұнтағы массасы мен целлюлоза өндірісі;

   8) қағаз және қатырма қағаз өндірісі;

   9) теріні енінен тілу мен илеуді, үлбірді өңдеу мен бояуды қоспағанда, тері өнімі өндірісі;

   10) жазу қағазы бұйымдары өндірісі болып табылады.
