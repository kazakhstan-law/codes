...
caused_by:
  code: '184077'
  title: «Қазақстан Республикасы Мемлекеттік күзет қызметі туралы ережені бекіту туралы» Қазақстан Республикасы Президентінің 2014 жылғы 4 мамырдағы № 814 Жарлығына өзгеріс енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/184077/kaz
