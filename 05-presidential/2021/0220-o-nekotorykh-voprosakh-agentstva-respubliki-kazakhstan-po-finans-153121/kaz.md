...
15. Функциялары:
    ...
    1) «Қылмыстық жолмен алынған кірістерді заңдастыруға (жылыстатуға) және терроризмді қаржыландыруға қарсы іс-қимыл туралы» Қазақстан Республикасының Заңына (бұдан әрі – Заң) сәйкес қаржы мониторингіне жататын ақшамен және (немесе) өзге мүлікпен операциялар туралы мәліметтер мен ақпаратты жинауды, өңдеуді, талдауды және пайдалануды жүзеге асыру;
