...
### Статья 1 Общая сфера применения Конвенция
...
2. Термин "постоянное представительство", в частности, включает:
   ...
   f) рудник, нефтяную и газовую скважину, карьер или любое другое место добычи природных ресурсов.
...
### Статья 7 Ассоциированные предприятия
...
### Статья 15 Доходы, полученные по месту работы
...
### Статья 17 Государственная служба
...
### Статья 19 Студенты, практиканты и исследователи
...
### Статья 29 Прекращения действия
