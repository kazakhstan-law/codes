...
act_code: '622'
language: kaz
title: Қазақстан Республикасының Үкiметi мен Өзбекстан Республикасының Үкiметi арасындағы Еркiн сауда туралы келiсiмдi бекiту туралы
requisite: Қазақстан Республикасының Заңы 1998 жылғы 8 мамыр № 224
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
registry_number: '622'
source: https://zan.gov.kz/client/#!/doc/622/kaz
---
