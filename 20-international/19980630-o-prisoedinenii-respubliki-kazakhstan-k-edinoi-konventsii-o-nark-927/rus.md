...
act_code: '927'
language: rus
title: О присоединении Республики Казахстан к Единой Конвенции о наркотических средствах 1961 года с поправками, внесенными в нее в соответствии с Протоколом 1972 года о поправках к Единой Конвенции о наркотических средствах 1961 года
requisite: Закон Республики Казахстан от 1 июля 1998 года № 257
form: КОНВ
type_codes:
- ЗАК
- КОНВ
...
registry_number: '927'
source: https://zan.gov.kz/client/#!/doc/927/rus
---
...
### Статья 7 Пересмотр постановления и рекомендаций комиссии
...
2. Эти доклады сообщаются Сторонам, а затем опубликовываются Генеральным Секретарем. Стороны разрешают их неограниченное распространение.
...
Стороны будут иметь особое управление для целей применения постановления настоящей Конвенции.
...
### Статья 19 Исчисление потребностей в наркотических средствах
...
### Статья 37 Наложение ареста и конфискации
...
### Статья 38 Обращение с наркоманами
