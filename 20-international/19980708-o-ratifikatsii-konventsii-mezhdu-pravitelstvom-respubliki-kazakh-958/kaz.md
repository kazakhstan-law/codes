...
act_code: '958'
language: kaz
title: Қазақстан Республикасының Үкiметi мен Түрiкменстан Үкiметi арасындағы Табыс пен капиталға қосарланған салық салуды болдырмау және салық төлеуден жалтаруға жол бермеу туралы конвенцияны бекiту туралы
requisite: Қазақстан Республикасының 1998 жылғы 9 шiлдедегі № 268 Заңы
form: КОНВ
type_codes:
- ЗАК
- КОНВ
...
registry_number: '958'
source: https://zan.gov.kz/client/#!/doc/958/kaz
---
