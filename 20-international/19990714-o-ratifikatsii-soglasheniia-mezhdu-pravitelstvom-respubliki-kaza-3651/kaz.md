...
act_code: '3651'
language: kaz
title: Қазақстан Республикасының Үкіметі мен Ресей Федерациясының Үкіметі арасындағы "Байқоңыр" кешенінде тұратын және/немесе жұмыс істейтін Қазақстан Республикасы мен Ресей Федерациясы азаматтарының әлеуметтік кепілдіктері туралы келісімді бекіту туралы
requisite: Қазақстан Республикасының Заңы 1999 жылғы 15 шілде № 423-I
form: СОГЛ
type_codes:
- СОГЛ
approved_by:
...
source: https://zan.gov.kz/client/#!/doc/3651/kaz
---
