...
act_code: '3653'
language: kaz
title: Қазақстан Республикасының Байқоңыр қаласы тұрғындарының зейнетақы алу құқығының кепілдіктері туралы Қазақстан Республикасының Үкіметі мен Ресей Федерациясының Үкіметі арасындағы келісімді бекіту туралы
requisite: Қазақстан Республикасының 1999 жылғы 15 шілдедегі № 425-I Заңы
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/3653/kaz
---
