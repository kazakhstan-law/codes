...
act_code: '4463'
language: kaz
title: Сығымдалған табиғи газды автокөлік құралдары үшін моторлық отын ретінде пайдалану саласындағы ынтымақтастық туралы келісімді бекіту туралы
requisite: Қазақстан Республикасы Үкіметінің Қаулысы 1999 жылғы 1 қараша N 1636
form: СОГЛ
type_codes:
- ПОСТ
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/4463/kaz
---
