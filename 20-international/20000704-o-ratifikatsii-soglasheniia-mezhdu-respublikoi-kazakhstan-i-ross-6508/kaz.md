...
act_code: '6508'
language: kaz
title: Қазақстан Республикасы мен Ресей Федерациясы арасындағы Ресей Федерациясы Қорғаныс министрлігінің 4-Мемлекеттік орталық полигонын (Қазақстан Республикасының аумағында орналасқан объектілері мен әскери алаңдарын) пайдалану тәртібі туралы келісімді бекіту туралы
requisite: Қазақстан Республикасының 2000 жылғы 5 шілдедегі № 71-ІІ Заңы
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/6508/kaz
---
...
<tr>
<td>1.</td>
<td>20 жеке сынақ станциясы</td>
<td>Батыс Қазақстан облысы, Жаңа қала ауданы, Жаңа Қазан ауылы</td>
</tr>
<tr>
<td>2.</td>
<td>
