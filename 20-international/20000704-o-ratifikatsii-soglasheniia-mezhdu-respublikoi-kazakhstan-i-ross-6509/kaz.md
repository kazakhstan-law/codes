...
caused_by:
  code: '34297'
  title: Қазақстан Республикасы мен Ресей Федерациясы арасындағы 1995 жылғы 20 қаңтардағы Ресей Федерациясы Қорғаныс министрлігінің 929 Мемлекеттік ұшу-сынақ орталығын (Қазақстан Республикасының аумағында орналасқан объектілері мен ұрыс алаңдары) пайдалану тәртібі туралы келісімге өзгерістер мен толықтырулар енгізу туралы хаттаманы ратификациялау туралы
  link: https://zan.gov.kz/client/#!/doc/34297/kaz
source: https://zan.gov.kz/client/#!/doc/6509/kaz/21.07.2007
---
