...
act_code: '7257'
language: kaz
title: Тәуелсiз Мемлекеттер Достастығына қатысушы мемлекеттердiң терроршылдыққа қарсы күрестегi ынтымақтастығы туралы шартты бекіту туралы
requisite: Қазақстан Республикасының 2000 жылғы 23 қазандағы № 93-ІІ Заңы
form: ДОГ
type_codes:
- ДОГ
- ЗАК
...
source: https://zan.gov.kz/client/#!/doc/7257/kaz
---
