...
act_code: '7279'
language: kaz
title: Ақпаратқа кіру, шешімдер қабылдау процесіне жұртшылықтың қатысуы және қоршаған ортаға қатысты мәселелер бойынша сот әділдігіне қол жеткізу туралы конвенцияны бекіту туралы
requisite: Қазақстан Республикасының Заңы 2000 жылғы 23 қазан № 92-ІІ
form: КОНВ
type_codes:
- ЗАК
- КОНВ
...
source: https://zan.gov.kz/client/#!/doc/7279/kaz
---
