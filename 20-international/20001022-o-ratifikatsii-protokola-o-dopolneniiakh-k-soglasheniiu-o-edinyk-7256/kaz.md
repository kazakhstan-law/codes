...
act_code: '7256'
language: kaz
title: Кеден одағына қатысушы мемлекеттердiң аумақтары арқылы өтетiн транзиттiң бiрыңғай шарттары туралы 1998 жылғы 22 қаңтардағы Келiсiмге толықтырулар хаттаманы бекіту туралы
requisite: Қазақстан Республикасының 2000 жылғы 23 қазандағы № 90-ІІ Заңы
form: ПРОТ
type_codes:
- ЗАК
- ПРОТ
...
source: https://zan.gov.kz/client/#!/doc/7256/kaz
---
...
## Кеден одағына қатысушы мемлекеттердiң аумақтары арқылы өтетiн транзиттiң бiрыңғай шарттары туралы 1998 жылғы 22 қаңтардағы Келiсiмге толықтырулар туралы ХАТТАМА
...
```
Беларусь Республикасы  Қазақстан Республикасы  Қырғыз Республикасы  Ресей Федерациясының
    Үкіметі үшін           Үкіметі үшін          Үкіметі үшін           Үкіметі үшін
```

> *Кедендік одаққа мүше мемлекеттердің*  
> *аумағы арқылы жүкті алып өтудің*  
> *біркелкі ережелері туралы Келісімге*  
> *N 1 қосымша*

### Тасымалдауға тыйым салынған қауіпті қалдықтардың

```
Тізімдемесі _____________________________________________________________________
...
> *Кедендік одаққа мүше мемлекеттердің*  
> *аумағы арқылы жүкті алып өтудің*  
> *бірыңғай ережелері туралы Келісімге*  
> *N 2 қосымша*
