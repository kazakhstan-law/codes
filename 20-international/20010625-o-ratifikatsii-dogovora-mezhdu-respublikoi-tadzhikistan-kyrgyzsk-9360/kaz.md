...
act_code: '9360'
language: kaz
title: Тәжікстан Республикасы, Қырғыз Республикасы, Қазақстан Республикасы мен Исмаилиттер имаматы арасындағы Орталық Азия университетін құру жөніндегі шартты бекіту туралы
requisite: Қазақстан Республикасының Заңы 2001 жылғы 26 маусым № 216-II
form: ДОГ
type_codes:
- ДОГ
- ЗАК
...
source: https://zan.gov.kz/client/#!/doc/9360/kaz
---
