...
act_code: '9531'
language: rus
title: О ратификации Протокола о финансировании между Правительством Французской Республики и Правительством Республики Казахстан (проект реабилитации и модернизации инфраструктуры водообеспечения и канализации города Алматы)
requisite: Закон Республики Казахстан от 11 июля 2001 года № 232-II
form: ПРОТ
type_codes:
- ЗАК
- ПРОТ
...
registry_number: '9531'
source: https://zan.gov.kz/client/#!/doc/9531/rus
---
...
Составлено в В четырех оригинальных экземплярах: два на французском языке и два на русском языке, причем текст на французском языке считается достоверным.
