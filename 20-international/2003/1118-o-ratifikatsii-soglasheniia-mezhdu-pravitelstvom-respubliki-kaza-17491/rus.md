...
Кому: (Фамилия и имя или наименование компании или предприятия)

```
      Адрес:            тел:               факс:
      Фамилия и имя, адрес, номер телефона и факса партнеров или
сотрудников предприятия и субподрядчиков.
...
5) _________________________________________
      ...
      а) пункт отправления:
      б) пункт назначения:
      в) основной маршрут с указанием остановок для посадки и
высадки пассажиров (подчеркнуто):
      ...
      Номерной знак транспортного средства, который будет использоваться
для перевозок ниже:
