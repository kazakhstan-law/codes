---
version_id: AI14185_0
act_code: '14185'
language: kaz
title: Тәуелсiз Мемлекеттер Достастығына қатысушы мемлекеттердің автомобиль жолдарымен мемлекетаралық тасымалдауды жүзеге асыратын көлiк құралдарының салмақтары мен көлемдерi жөнiндегi келiсімді бекiту туралы
requisite: Қазақстан Республикасы Үкіметінің қаулысы. 2003 жылғы 17 қаңтар N 32
form: СОГЛ
type_codes:
- ПОСТ
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/14185/kaz
---
