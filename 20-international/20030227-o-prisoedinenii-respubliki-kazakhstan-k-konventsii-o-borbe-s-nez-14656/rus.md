...
caused_by:
  code: '100136'
  title: О ратификации Протокола 2005 года к Протоколу о борьбе с незаконными актами, направленными против безопасности стационарных платформ, расположенных на континентальном шельфе
  link: https://zan.gov.kz/client/#!/doc/100136/rus
source: https://zan.gov.kz/client/#!/doc/14656/rus/15.03.2016
---
...
3. Любое государство-участник, которое установило юрисдикцию, упомянутую в пункте 2, уведомляет об этом Генерального секретаря
   ...
   Международной морской организации (именуемого ниже "Генеральный секретарь"). Если такое государство-участник впоследствии отказывается от такой юрисдикции, оно уведомляет об этом Генерального секретаря.
