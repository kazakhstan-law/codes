---
version_id: AI19146_9
act_code: '19146'
language: rus
title: О некоторых вопросах государственных закупок отдельных видов сельскохозяйственной продукции
requisite: Постановление Правительства Республики Казахстан от 27 марта 2004 года N 371. Утратило силу постановлением Правительства Республики Казахстан от 28 августа 2008 года N 781.
form: ДОГ
type_codes:
- ДОГ
- ПОСТ
...
caused_by:
  code: '23474'
  title: Об утверждении перечня товаров, приобретение которых государственными предприятиями, юридическими лицами, пятьдесят и более процентов акций (долей) или контрольный пакет акций которых принадлежат государству, и аффилиированными с ними юридическими лицами (за исключением субъектов естественных монополий), с целью их последующей оптово-розничной реализации не является предметом государственных закупок
  link: https://zan.gov.kz/client/#!/doc/23474/rus
source: https://zan.gov.kz/client/#!/doc/19146/rus/08.04.2005
---
