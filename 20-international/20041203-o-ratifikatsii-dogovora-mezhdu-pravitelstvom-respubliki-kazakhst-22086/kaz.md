---
version_id: AI22086_0
act_code: '22086'
language: kaz
title: Қазақстан Республикасының Үкіметі мен "SOS KINDERDORF INTERNATIONAL" SOS балалар ауылдарын құру жөніндегі халықаралық қоғам арасындағы шартты бекіту туралы
requisite: Қазақстан Республикасының 2004 жылғы 3 желтоқсандағы № 5 Заңы
form: ДОГ
type_codes:
- ДОГ
- ЗАК
...
registry_number: '22086'
source: https://zan.gov.kz/client/#!/doc/22086/kaz/03.12.2004
---
...
2.9. "SOS-балалар ауылы" атауы мен эмблемасы Қазақстан Республикасының тарапынан тиiстi құқықтық қорғалуға және тек SOS KDI-ге мүше ұйымдардың және тиiстi жазбаша санкциялары барлардың ғана осы атау мен эмблеманы пайдалану құқығы болатынына кепiлдiктi қамтамасыз етуге мiндеттенедi.
