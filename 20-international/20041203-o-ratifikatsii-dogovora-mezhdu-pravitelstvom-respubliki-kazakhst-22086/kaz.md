...
caused_by:
  code: '42472'
  title: Қазақстан Республикасының Үкіметі мен "SOS KINDERDORF INTERNATIONAL" SOS балалар ауылдарын құру жөніндегі халықаралық қоғам арасындағы шартқа толықтырулар енгізу туралы хаттаманы ратификациялау туралы
  link: https://zan.gov.kz/client/#!/doc/42472/kaz
source: https://zan.gov.kz/client/#!/doc/22086/kaz
---
