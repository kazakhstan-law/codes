...
(Проект повышения конкурентоспособности сельскохозяйственной продукции)
...
Категория расходов          (в долл. США)      может  финансироваться

(1) Работы                 5 300 000        70 %
(2) Товары                 6 700 000        100 % иностранных
                                            расходов, 100 % местных
                                            расходов (франко-завод)
                                            и 84 % местных
                                            расходов для товаров,
                                            закупленных на местном
                                            рынке

(3) Гранты                11 000 000        100 % профинансированных
                                            средств
(4) Нераспределенная      1 000 000
    сумма
      Итого               24 000 000
```
...
#### График производства амортизационных отчислений Погашение основной суммы займа

```
Дата платежа                              (в долл. США)
Каждого 15 апреля и 15
октября
