---
version_id: AI32742_1
act_code: '32742'
language: rus
title: О ратификации Соглашения между Правительством Республики Казахстан и Подготовительной комиссией Организации по Договору о всеобъемлющем запрещении ядерных испытаний о проведении мероприятий, включая постсертификационные мероприятия, на объектах по международному мониторингу в поддержку Договора о всеобъемлющем запрещении ядерных испытаний
requisite: Закон Республики Казахстан от 12 апреля 2007 года № 243
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
registry_number: '32742'
source: https://zan.gov.kz/client/#!/doc/32742/rus
---
