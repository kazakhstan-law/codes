---
version_id: AI44478_1
act_code: '44478'
language: rus
title: 'О ратификации Конвенции о запрещении или ограничении применения конкретных видов обычного оружия, которые могут считаться наносящими чрезмерные повреждения или имеющими неизбирательное действие, и Протоколов к ней: Протокола о необнаруживаемых осколках (Протокол I), Протокола о запрещении или ограничении применения зажигательного оружия (Протокол III) и Протокола об ослепляющем лазерном оружии (Протокол IV)'
requisite: Закон Республики Казахстан от 23 февраля 2009 года № 140-IV
form: КОНВ
type_codes:
- ЗАК
- КОНВ
...
version_date: 2009-02-23
registry_number: '44478'
source: https://zan.gov.kz/client/#!/doc/44478/rus
---
