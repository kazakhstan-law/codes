...
caused_by:
  code: '64597'
  title: Қазақстан Республикасы Қаржы нарығын және қаржы ұйымдарын реттеу мен қадағалау агенттігі Басқармасының "Міндетті, ерікті және ерікті кәсіби зейнетақы жарналарының есебінен зейнетақымен қамсыздандыру туралы үлгі шарттарын бекіту туралы" 2009 жылғы 27 ақпандағы № 36 қаулысына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/64597/kaz
