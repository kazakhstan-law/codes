...
<table>
<tr>
<td colspan="4">1. Экспортер (наименование экспортера, адрес, страна)</td>
...
<tr>
<td colspan="4">2. Получатель (наименование импортера, адрес, страна)</td>
</tr>
<tr>
<td colspan="4">3. Средства транспорта и маршрут следования (насколько известно)</td>
<td colspan="2">4. Для официальных отметок</td>
</tr>
<tr>
<td>
5.
