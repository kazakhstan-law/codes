---
version_id: AI62022_0
act_code: '62022'
language: kaz
title: Қазақстан Республикасының Үкіметі мен Грузия Үкіметі арасында Терроризмге, есірткі құралдарының, психотроптық заттар мен прекурсорлардың заңсыз айналымына, ұйымдасқан және өзге де қылмыс түрлеріне қарсы күрестегі ынтымақтастық туралы келісімді бекіту туралы
requisite: Қазақстан Республикасы Үкіметінің 2011 жылғы 5 желтоқсандағы № 1450 Қаулысы
form: СОГЛ
type_codes:
- ПОСТ
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/62022/kaz
---
