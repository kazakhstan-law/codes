---
version_id: AI72744_0
act_code: '72744'
language: kaz
title: 'Қазақстан Республикасы мен Халықаралық Қайта Құру және Даму Банкi арасындағы Қарыз туралы келiсiмді (Шығыс-Батыс автомобиль жолдарын дамыту жобасы (Алматы-Қорғас учаскесі): Батыс Еуропа – Батыс Қытай халықаралық транзит дәлізі (ОАӨЭЫ 1b) ратификациялау туралы'
requisite: Қазақстан Республикасының Заңы 2013 жылғы 23 мамырдағы № 100-V ҚРЗ
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/72744/kaz
---
