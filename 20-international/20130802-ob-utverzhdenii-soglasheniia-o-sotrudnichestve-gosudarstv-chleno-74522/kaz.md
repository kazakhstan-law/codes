---
version_id: AI74522_0
act_code: '74522'
language: kaz
title: Еуразиялық экономикалық қоғамдастыққа мүше мемлекеттердің дәрілік заттардың (дәрілік препараттардың), медициналық мақсаттағы бұйымдар мен медициналық техниканың (медициналық бұйымдар) айналысы саласындағы ынтымақтастығы туралы келісімді бекіту туралы
requisite: Қазақстан Республикасы Үкіметінің 2013 жылғы 2 тамыздағы № 766 қаулысы
form: СОГЛ
type_codes:
- ПОСТ
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/74522/kaz
---
