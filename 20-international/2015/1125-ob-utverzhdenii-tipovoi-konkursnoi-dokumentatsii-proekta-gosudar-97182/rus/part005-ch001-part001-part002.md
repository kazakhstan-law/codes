...
<td>«Строительство и эксплуатация детского сада на ____ мест в ___________ (указать наименование и местонахождение населенного пункта)»</td>
</tr>
<tr>
...
<tr>
<td>Объект ГЧП</td>
<td>Детский сад на ____ мест</td>
</tr>
<tr>
...
<tr>
<td>2</td>
<td>Предоставление Организатором конкурса копии Типовой КД лицам, изъявившим желание участвовать в Конкурсе</td>
<td>со дня опубликования объявления о проведении Конкурса</td>
</tr>
<tr>
<td>3</td>
<td>Разъяснение, обсуждение и корректировка положений Типовой КД, лицам получившим ее копию</td>
...
<td>с момента получения Типовой КД до __:00 часов «__» _______20__ года</td>
</tr>
<tr>
<td>8</td>
...
<td>Родительская плата = __________ (указать количество) тенге</td>
<td>
