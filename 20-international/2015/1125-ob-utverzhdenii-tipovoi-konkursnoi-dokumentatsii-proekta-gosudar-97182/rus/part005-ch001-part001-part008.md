...
<td>«Строительство и эксплуатация многоэтажного жилого комплекса на ___ квартир с подземным паркингом на ___ машино-мест в __________ (указать наименование и местонахождение населенного пункта)»</td>
</tr>
<tr>
...
<tr>
<td>Объект ГЧП</td>
<td>Многоэтажный жилой комплекс на ___ квартир с подземным паркингом на ___ машино-мест</td>
</tr>
<tr>
<td>Место нахождения Объекта ГЧП</td>
<td>Республика Казахстан, __________________ (указать наименование и местонахождение населенного пункта), _______________ (адрес либо описание местоположения)</td>
</tr>
<tr>
...
<tr>
<td>2</td>
<td>Предоставление Организатором конкурса копии Типовой конкурсной документация проекта ГЧП в сфере жилищного строительства (жилой комплекс) лицам, изъявившим желание участвовать в Конкурсе</td>
<td>со дня опубликования объявления о проведении Конкурса</td>
</tr>
<tr>
<td>3</td>
<td>Разъяснение, обсуждение и корректировка положений Типовой конкурсной документация проекта ГЧП в сфере жилищного строительства (жилой комплекс), лицам получившим ее копию</td>
<td>не позднее «___»______ 20__ года (в течение 3 (трех) рабочих дней со дня регистрации запроса)</td>
</tr>
<tr>
<td>4</td>
<td>
...
<td>с момента получения Типовой конкурсной документация проекта ГЧП в сфере жилищного строительства (жилой комплекс) до __:00 часов «__» _______20__ года</td>
</tr>
<tr>
<td>8</td>
...
<tr>
<td>15</td>
<td>Принятие государственных обязательств по Проекту ГЧП местных исполнительных органов местными уполномоченными органами по исполнению бюджета на основании предложении соответствующей бюджетной комисии</td>
<td>не позднее «___»______ 20_____ года</td>
</tr>
<tr>
<td>16</td>
<td>Разработка и внесения проекта решения маслихата о принятии государственных обязательств</td>
...
<td>в течение ____ (указать прописью) дней после заключения Типового договора</td>
</tr>
</table>
...
<td>__ (указать количество) лет</td>
<td>
...
<td>Прибавляется ___ (указать количество) балл за каждый месяц сокращения срока по данному критерию</td>
<td>К6</td>
</tr>
<tr>
<td>7</td>
...
<td>___ (указать количество) % от закупаемых товаров, работах, услугах</td>
<td>
Прибавляется ___ (указать количество) балл за каждые ___ (указать количество) % увеличения местного содержания;
Вычитается ___ (указать количество) балл за каждые ___ (указать количество) % уменьшения местного содержания
</td>
...
<tr>
<td></td>
<td colspan="3">Наличие квалифицированных специалистов</td>
<td></td>
</tr>
<tr>
<td rowspan="2">9</td>
...
<td>Прибавляется ___ (указать количество) балл за каждые ___ (указать количество) % увеличения доли</td>
<td rowspan="2">К9</td>
</tr>
<tr>
