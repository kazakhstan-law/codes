---
version_id: AI99392_0
act_code: '99392'
language: kaz
title: Қазақстан Республикасы мен Халықаралық Қайта Құру және Даму Банкі (энергия тиімділігін арттыру және жастар корпусын дамыту бағдарламасы үшін бір донордың Траст қоры әкімшісі ретінде әрекет етуші) арасындағы Грант туралы келісімді (Жастар корпусын дамыту жобасы) ратификациялау туралы
requisite: Қазақстан Республикасының Заңы 2016 жылғы 18 ақпандағы № 454-V ҚРЗ
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/99392/kaz
---
