---
version_id: AI99680_1
act_code: '99680'
language: rus
title: О ратификации Соглашения о реализации в 2015-2016 годах пилотного проекта по введению маркировки товаров контрольными (идентификационными) знаками по товарной позиции "Предметы одежды, принадлежности к одежде и прочие изделия из натурального меха"
requisite: Закон Республики Казахстан от 29 февраля 2016 года № 466-V ЗРК
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/99680/rus
---
