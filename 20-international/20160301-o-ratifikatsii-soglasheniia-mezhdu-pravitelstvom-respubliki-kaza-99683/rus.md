---
version_id: AI99683_1
act_code: '99683'
language: rus
title: О ратификации Соглашения между Правительством Республики Казахстан и Правительством Республики Молдова о реадмиссии лиц с незаконным пребыванием и Исполнительного протокола по реализации Соглашения между Правительством Республики Казахстан и Правительством Республики Молдова о реадмиссии лиц с незаконным пребыванием
requisite: Закон Республики Казахстан от 1 марта 2016 года № 468-V ЗРК
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/99683/rus
---
...
<pre>
       ...
       2. Предыдущие фамилии: __________________________
...
1\. Состояние здоровья (например, возможные указания на необходимость особого медицинского ухода, латинское название болезни):
...
3\. Способ передачи лица и пункт пропуска через государственную границу:
