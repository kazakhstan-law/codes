---
version_id: '121427_331378'
act_code: '121427'
language: kaz
title: Қазақстан Республикасының Үкіметі мен Америка Құрама Штаттарының Үкіметі арасындағы мемлекеттік әуе кемелеріне аэронавигациялық қызмет көрсету үшін төлемақы алуға қатысты келісімді ратификациялау туралы
requisite: Қазақстан Республикасының Заңы 2018 жылғы 5 мамырдағы № 154-VІ ҚРЗ
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
registry_number: '121427'
source: https://zan.gov.kz/client/#!/doc/121427/kaz
---

# Қазақстан Республикасының Үкіметі мен Америка Құрама Штаттарының Үкіметі арасындағы мемлекеттік әуе кемелеріне аэронавигациялық қызмет көрсету үшін төлемақы алуға қатысты келісімді ратификациялау туралы
...
Үкіметі үшін                             ШтаттарыныңҮкіметі үшін
```
