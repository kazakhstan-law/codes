---
version_id: '132213_409192'
act_code: '132213'
language: kaz
title: Тәуелсіз Мемлекеттер Достастығына қатысушы мемлекеттердің ғарыш кеңістігін бейбіт мақсаттарда зерттеу және пайдалану саласындағы бірлескен қызметін жүзеге асыру туралы келісімді бекіту туралы
requisite: Қазақстан Республикасы Үкіметінің 2019 жылғы 6 маусымдағы № 382 қаулысы
form: СОГЛ
type_codes:
- ПОСТ
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/132213/kaz
---
