---
version_id: '141196_484676'
act_code: '141196'
language: rus
title: О ратификации Договора между Республикой Казахстан и Федеративной Республикой Бразилия о выдаче лиц
requisite: Закон Республики Казахстан от 31 марта 2020 года № 309-VІ ЗРК
form: ДОГ
type_codes:
- ДОГ
- ЗАК
...
source: https://zan.gov.kz/client/#!/doc/141196/rus
---
...
# ДОГОВОР МЕЖДУ РЕСПУБЛИКОЙ КАЗАХСТАН И ФЕДЕРАТИВНОЙ РЕСПУБЛИКОЙ БРАЗИЛИЯ О ВЫДАЧЕ ЛИЦ
...
## Статья 5 Уголовное преследование граждан
...
## Статья 7 Выдача третьему государству
...
## Статья 9 Смертная казнь и пожизненное лишение свободы
...
## Статья 11 Освобождение от легализации
...
## Статья 12 Временное содержание под стражей
...
## Статья 13 Решение по запросу и передача
...
## Статья 14 Отсрочка передачи и временная выдача
...
## Статья 15 Передача документов, активов и имущества
...
## Статья 16 Конкурирующие запросы
...
## Статья 17 Упрощенная выдача лица
...
## Статья 18 Возвращение выданного лица
...
## Статья 19 Транзит выданного лица
...
## Статья 22 Разрешение разногласий
...
## Статья 23 Совместимость с международными договорами
...
<td>
<strong>ЗА ФЕДЕРАТИВНУЮ РЕСПУБЛИКУ БРАЗИЛИЯ</strong>
</td>
</tr>
</table>
