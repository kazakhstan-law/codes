---
version_id: '147630_497242'
act_code: '147630'
language: rus
title: О ратификации Договора между Республикой Казахстан и Украиной о правовой помощи по уголовным делам
requisite: Закон Республики Казахстан от 19 октября 2020 года № 368-VI ЗРК
form: ДОГ
type_codes:
- ДОГ
- ЗАК
...
registry_number: '147630'
source: https://zan.gov.kz/client/#!/doc/147630/rus
---
...
### СТАТЬЯ 1 ЦЕЛЬ И ОБЪЕМ ПРАВОВОЙ ПОМОЩИ
...
### СТАТЬЯ 7 КОНФИДЕНЦИАЛЬНОСТЬ И ОГРАНИЧЕНИЯ ПО ИСПОЛЬЗОВАНИЮ
...
### СТАТЬЯ 12 ВРЕМЕННАЯ ПЕРЕДАЧА ЛИЦ, НАХОДЯЩИХСЯ ПОД СТРАЖЕЙ В ЗАПРАШИВАЮЩЕЙ СТОРОНЕ
...
### СТАТЬЯ 15 ВОЗВРАЩЕНИЕ ПРЕДМЕТОВ, ДОКУМЕНТОВ И ИНЫХ ОБЪЕКТОВ
...
### СТАТЬЯ 16 УСТАНОВЛЕНИЕ ФИНАНСОВОЙ ИНФОРМАЦИИ
...
### СТАТЬЯ 17 ЗАСЛУШИВАНИЕ ПОСРЕДСТВОМ ВИДЕОКОНФЕРЕНЦИИ
...
### СТАТЬЯ 18 СОВМЕСТНЫЕ СЛЕДСТВЕННЫЕ ГРУППЫ
...
### СТАТЬЯ 19 ДОБРОВОЛЬНАЯ ПЕРЕДАЧА ИНФОРМАЦИИ
...
### СТАТЬЯ 21 ОБМЕН ИНФОРМАЦИЕЙ ОБ УГОЛОВНОМ ПРЕСЛЕДОВАНИИ
...
### СТАТЬЯ 22 ОСВОБОЖДЕНИЕ ОТ ЛЕГАЛИЗАЦИИ
...
### СТАТЬЯ 23 СООТНОШЕНИЕ С ДРУГИМИ МЕЖДУНАРОДНЫМИ ДОГОВОРАМИ
