...
### СТАТЬЯ 1 ОБЯЗАТЕЛЬСТВО ВЫДАЧИ ЛИЦА
...
### СТАТЬЯ 4 УГОЛОВНОЕ ПРЕСЛЕДОВАНИЕ В СЛУЧАЕ ОТКАЗА В ВЫДАЧЕ
...
### СТАТЬЯ 5 ОТСРОЧКА ВЫДАЧИ ИЛИ ВРЕМЕННАЯ ВЫДАЧА
...
### СТАТЬЯ 9 ЭКСТРАДИЦИОННЫЙ (ПРЕДВАРИТЕЛЬНЫЙ) АРЕСТ
...
### СТАТЬЯ 11 ПОВТОРНАЯ ВЫДАЧА ЛИЦА
...
### СТАТЬЯ 14 ПЕРЕДАЧА СОБСТВЕННОСТИ И ПРЕДМЕТОВ
...
2. Запрашиваемая Договаривающаяся Сторона несет расходы по любым процедурам в ее юрисдикции, связанным с запросом о выдаче лица.
...
### СТАТЬЯ 19 РАЗРЕШЕНИЕ СПОРОВ И РАЗНОГЛАСИЙ
...
<th>ЗА РЕСПУБЛИКУ СЕВЕРНАЯ МАКЕДОНИЯ</th>
</tr>
</table>
