---
version_id: '173253_606424'
act_code: '173253'
language: rus
title: О ратификации Соглашения об обмене информацией в сфере противодействия легализации (отмыванию) доходов, полученных преступным путем, и финансированию терроризма при перемещении наличных денежных средств и (или) денежных инструментов через таможенную границу Евразийского экономического союза
requisite: Закон Республики Казахстан от 27 октября 2022 года № 149-VII ЗРК
form: СОГЛ
type_codes:
- ЗАК
- СОГЛ
...
source: https://zan.gov.kz/client/#!/doc/173253/rus
---
