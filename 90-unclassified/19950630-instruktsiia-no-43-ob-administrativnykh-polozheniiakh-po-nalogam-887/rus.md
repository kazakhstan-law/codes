...
caused_by:
  code: '4079'
  title: О внесении изменений и дополнений в Инструкцию N 43 "Об административных положениях по налогам и другим обязательным платежам в бюджет"
  link: https://zan.gov.kz/client/#!/doc/4079/rus
source: https://zan.gov.kz/client/#!/doc/887/rus/03.08.1999
