...
caused_by:
  code: '2012'
  title: Об утверждении изменений и дополнений в Инструкцию о порядке открытия, ведения и закрытия банковских счетов клиентов в банках второго уровня
  link: https://zan.gov.kz/client/#!/doc/2012/rus
