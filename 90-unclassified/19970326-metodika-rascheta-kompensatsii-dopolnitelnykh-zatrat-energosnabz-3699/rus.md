...
act_code: '3699'
language: rus
title: Методика расчета компенсации дополнительных затрат энергоснабжающей организации потребителями энергии для финансирования решения и реконструкции энергоисточников, строительства сетей транспортировки энергии и электроподстанций общего пользования при подключении дополнительных нагрузок
