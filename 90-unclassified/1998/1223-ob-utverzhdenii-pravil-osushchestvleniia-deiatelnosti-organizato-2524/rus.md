...
1) государственные ценные бумаги Республики Казахстан, в том числе эмитированные в соответствии с законодательством других государств;
...
При этом не может быть включен в Официальный Список Организатора торгов и находиться в нем тип ценной бумаги, по которому отсутствует(ют) маркет-мейкер(ы). В случае, если по какому-либо типу ценной бумаги, находящемуся в Официальном списке Организатора торгов, не осталось ни одного маркет-мейкера, данный тип ценной бумаги подлежит обязательному делистингу в течение трех месяцев со дня наступления такого случая.
...
Организатор торгов обязан произвести делистинг акций данного типа, если в течение одного года объем сделок с ними (в акциях) не превысил половины процента от их общего объявленного к выпуску количества.
...
42. Заключение сделок с ценными бумагами на проводимых Организатором торгах производится их участниками в соответствии с порядком, установленным Внутренними документами данного Организатора торгов, которые помимо иных возможных норм должны содержать указания на способы котировки, допускаемые к использованию в отношении определенных классов (типов) ценных бумаг или на определенной Площадке.
    ...
    При этом Внутренними документами Организатора торгов должно быть установлено, что участник торгов, объявивший индикативную (мягкую) котировку, обязан в ходе Торговой сессии заключить сделку с данными ценными бумагами по объявленной цене в объеме, по крайней мере, одного лота (при наличии встречного предложения по этой же цене).
