...
caused_by:
  code: '3447'
  title: О внесении изменений в Инструкцию о порядке организации и проведения проверок государственных учреждений по соблюдению им положений нормативных правовых актов по государственным закупкам
  link: https://zan.gov.kz/client/#!/doc/3447/rus
