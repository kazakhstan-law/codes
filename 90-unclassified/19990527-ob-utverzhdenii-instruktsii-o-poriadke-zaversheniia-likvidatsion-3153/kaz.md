...
act_code: '3153'
language: kaz
title: Қызметті ықтиярсыз (соттан тыс) тоқтатылған банктерде тарату ісін аяқтау тәртібі туралы нұсқаулықты бекіту туралы
requisite: Қазақстан Республикасының Ұлттық Банкі Басқармасы 1999 жылғы 28 мамыр N 122 Қаулы. Күші жойылды - ҚР Қаржы нарығын және қаржы ұйымдарын реттеу мен қадағалау агенттігі Басқармасының 2006 жылғы 25 наурыздағы N 81 қаулысымен.
form: null
type_codes:
- ИНСТ
approved_by:
