...
caused_by:
  code: '13568'
  title: '"Кеден төлемдерiн салу мен кеден төлемдерiн қайтарып алудың тәртiбi туралы нұсқаулықты бекiту туралы" Қазақстан Республикасы Мемлекеттiк кiрiс министрлiгiнiң Кеден комитеті төрағасының 2001 жылғы 9 ақпандағы N 45 бұйрығына өзгерiстер енгiзу туралы'
  link: https://zan.gov.kz/client/#!/doc/13568/kaz
